...
from gingerdj.core import signals, signing
from gingerdj.core.exceptions import DisallowedRedirect
from gingerdj.core.serializers.json import GingerJSONEncoder
from gingerdj.http.cookie import SimpleCookie
from gingerdj.utils import timezone
from gingerdj.utils.datastructures import CaseInsensitiveMapping
from gingerdj.utils.encoding import iri_to_uri
from gingerdj.utils.http import content_disposition_header, http_date
...
class JsonResponse(HttpResponse):
    ...
    :param encoder: Should be a json encoder class. Defaults to
      ``gingerdj.core.serializers.json.GingerJSONEncoder``.
