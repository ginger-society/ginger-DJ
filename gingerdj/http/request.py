...
from gingerdj.core.files import uploadhandler
...
from gingerdj.utils.encoding import escape_uri_path, iri_to_uri
from gingerdj.utils.functional import cached_property
from gingerdj.utils.http import is_same_domain, parse_header_parameters
...
class QueryDict(MultiValueDict):
    ...
    def __init__(self, query_string=None, mutable=False, encoding=None):
        ...
        try:
            ...
            # parse_qsl() is True. As that is not used by GingerDJ, assume that
...
# gingerdj.utils.encoding.force_str() for parsing URLs and form inputs. Thus,
