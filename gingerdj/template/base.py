"""
This is the GingerDJ template system.
...
from gingerdj.template.context import BaseContext
from gingerdj.utils.formats import localize
from gingerdj.utils.html import conditional_escape, escape
...
from gingerdj.utils.text import get_text_list, smart_split, unescape_string_literal
from gingerdj.utils.timezone import template_localtime
from gingerdj.utils.translation import gettext_lazy, pgettext_lazy
...
logger = logging.getLogger("gingerdj.template")
...
class Template:
    def __init__(self, template_string, origin=None, name=None, engine=None):
        ...
        # exactly one GingerDJ template engine is configured, use that engine.
...
class Parser:
    def __init__(self, tokens, libraries=None, builtins=None, origin=None):
        ...
        # should use a key to namespace any added data. The 'gingerdj' namespace
