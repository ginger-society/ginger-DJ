...
from gingerdj.template.context import make_context
...
class GingerTemplates(BaseEngine):
...
def get_template_tag_modules():
    ...
    libraries.
    """
    candidates = ["gingerdj.templatetags"]
    candidates.extend(
...
def get_installed_libraries():
    ...
    gingerdj.templatetags.i18n is stored as i18n.
    """
    return {
