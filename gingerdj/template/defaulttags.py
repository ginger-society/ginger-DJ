...
from gingerdj.utils.html import conditional_escape, escape, format_html
from gingerdj.utils.lorem_ipsum import paragraphs, words
...
class SpacelessNode(Node):
    ...
    def render(self, context):
        from gingerdj.utils.html import strip_spaces_between_tags
...
def load(parser, token):
    ...
    ``gingerdj/templatetags/news/photos.py``::
