...
from gingerdj.prometheus.conf import NAMESPACE, PROMETHEUS_LATENCY_BUCKETS
from gingerdj.prometheus.utils import PowersOf, Time, TimeSince
...
class Metrics:
    ...
    def register(self):
        ...
        self.requests_unknown_latency_before = self.register_metric(
            Counter,
            "ginger_http_requests_unknown_latency_including_middlewares_total",
            (
        ...
        self.requests_latency_by_view_method = self.register_metric(
            Histogram,
            "ginger_http_requests_latency_seconds_by_view_method",
        ...
        self.requests_unknown_latency = self.register_metric(
            Counter,
            "ginger_http_requests_unknown_latency_total",
        ...
        self.requests_ajax = self.register_metric(
            Counter,
            "ginger_http_ajax_requests_total",
            "Count of AJAX requests.",
            namespace=NAMESPACE,
        )
        self.requests_by_method = self.register_metric(
            Counter,
            "ginger_http_requests_total_by_method",
        ...
        self.requests_by_transport = self.register_metric(
            Counter,
            "ginger_http_requests_total_by_transport",
        ...
        self.requests_by_view_transport_method = self.register_metric(
            Counter,
            "ginger_http_requests_total_by_view_transport_method",
        ...
        self.requests_body_bytes = self.register_metric(
            Histogram,
            "ginger_http_requests_body_total_bytes",
        ...
        self.responses_by_templatename = self.register_metric(
            Counter,
            "ginger_http_responses_total_by_templatename",
        ...
        self.responses_by_status = self.register_metric(
            Counter,
            "ginger_http_responses_total_by_status",
        ...
        self.responses_by_status_view_method = self.register_metric(
            Counter,
            "ginger_http_responses_total_by_status_view_method",
        ...
        self.responses_body_bytes = self.register_metric(
            Histogram,
            "ginger_http_responses_body_total_bytes",
        ...
        self.responses_by_charset = self.register_metric(
            Counter,
            "ginger_http_responses_total_by_charset",
        ...
        self.responses_streaming = self.register_metric(
            Counter,
            "ginger_http_responses_streaming_total",
        ...
        self.exceptions_by_type = self.register_metric(
            Counter,
            "ginger_http_exceptions_total_by_type",
        ...
        self.exceptions_by_view = self.register_metric(
            Counter,
            "ginger_http_exceptions_total_by_view",
