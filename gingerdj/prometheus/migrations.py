...
from gingerdj.db.backends.dummy.base import DatabaseWrapper
from prometheus_client import Gauge

from .conf import NAMESPACE

unapplied_migrations = Gauge(
    "ginger_migrations_unapplied_total",
...
applied_migrations = Gauge(
    "ginger_migrations_applied_total",
...
def ExportMigrations():
    ...
    if "default" in connections and (isinstance(connections["default"], DatabaseWrapper)):
        ...
        # i.e. the user is not using any databases. GingerDJ "helpfully"
