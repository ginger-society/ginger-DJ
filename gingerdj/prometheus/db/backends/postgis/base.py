from gingerdj.contrib.gis.db.backends.postgis import base

from prometheus.db.backends.common import get_postgres_cursor_class
from prometheus.db.common import DatabaseWrapperMixin, ExportingCursorWrapper
