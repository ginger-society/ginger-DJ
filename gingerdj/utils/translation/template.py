...
from gingerdj.template.base import Lexer, TokenType
...
def templatize(src, origin=None):
    """
    Turn a GingerDJ template into something that is understood by xgettext. It
    does so by translating the GingerDJ translation tags into standard gettext
