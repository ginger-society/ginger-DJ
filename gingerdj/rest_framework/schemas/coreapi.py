...
from gingerdj.rest_framework import RemovedInDRF317Warning, exceptions, serializers
from gingerdj.rest_framework.compat import coreapi, coreschema, uritemplate
