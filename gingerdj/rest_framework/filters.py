...
from gingerdj.utils.text import smart_split, unescape_string_literal
...
from gingerdj.rest_framework.fields import CharField
...
class SearchFilter(BaseFilterBackend):
    ...
    def filter_queryset(self, request, queryset, view):
        ...
        if self.must_call_distinct(queryset, search_fields):
            # inspired by gingerdj.contrib.admin
