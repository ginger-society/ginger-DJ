...
from gingerdj.http import HttpRequest, QueryDict
from gingerdj.http.request import RawPostDataException
...
class Request:
    ...
    def __init__(
        ...
        assert isinstance(request, HttpRequest), (
            ...
            "`gingerdj.http.HttpRequest`, not `{}.{}`.".format(
    ...
    def user(self, value):
        ...
        compatibility with gingerdj.contrib.auth where the user property is
