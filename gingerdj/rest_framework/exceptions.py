...
(`gingerdj.http.Http404` and `gingerdj.core.exceptions.PermissionDenied`)
"""
...
from gingerdj.rest_framework import status
from gingerdj.rest_framework.utils.serializer_helpers import ReturnDict, ReturnList
