...
from gingerdj.contrib.admin import helpers, widgets
from gingerdj.contrib.admin.checks import (
    BaseModelAdminChecks,
    InlineModelAdminChecks,
    ModelAdminChecks,
)
from gingerdj.contrib.admin.exceptions import DisallowedModelAdminToField, NotRegistered
...
from gingerdj.contrib.admin.widgets import AutocompleteSelect, AutocompleteSelectMultiple
...
from gingerdj.db import models, router, transaction
from gingerdj.db.models.constants import LOOKUP_SEP
from gingerdj.forms.formsets import DELETION_FIELD_NAME, all_valid
...
from gingerdj.forms.widgets import CheckboxSelectMultiple, SelectMultiple
from gingerdj.http import HttpResponseRedirect
from gingerdj.http.response import HttpResponseBase
from gingerdj.template.response import SimpleTemplateResponse, TemplateResponse
...
from gingerdj.utils.text import (
    capfirst,
    format_lazy,
    get_text_list,
    smart_split,
...
from gingerdj.views.decorators.csrf import csrf_protect
...
class BaseModelAdmin(metaclass=forms.MediaDefiningClass):
    ...
    # RemovedInGinger60Warning: when the deprecation ends, replace with:
    # def lookup_allowed(self, lookup, value, request):
    def lookup_allowed(self, lookup, value, request=None):
        from gingerdj.contrib.admin.filters import SimpleListFilter
    ...
    def has_change_permission(self, request, obj=None):
        ...
        GingerDJ model instance, the default implementation doesn't examine the
        `obj` parameter.
...
class ModelAdmin(BaseModelAdmin):
    ...
    def log_addition(self, request, obj, message):
        ...
        """
        # from gingerdj.contrib.admin.models import ADDITION, LogEntry
    ...
    def log_deletion(self, request, obj, object_repr):
        ...
        # from gingerdj.contrib.admin.models import DELETION, LogEntry
    ...
    def message_user(
        ...
        posts a message using the gingerdj.contrib.messages backend.
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        """
        from gingerdj.contrib.admin.views.main import ERROR_FLAG
    ...
    def history_view(self, request, object_id, extra_context=None):
        ...
        from gingerdj.contrib.admin.views.main import PAGE_VAR
