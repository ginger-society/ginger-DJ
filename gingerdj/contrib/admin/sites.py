...
from gingerdj.contrib.admin import ModelAdmin, actions
...
from gingerdj.db.models.base import ModelBase
from gingerdj.http import Http404, HttpResponsePermanentRedirect, HttpResponseRedirect
from gingerdj.template.response import TemplateResponse
from gingerdj.urls import NoReverseMatch, Resolver404, resolve, reverse
from gingerdj.utils.decorators import method_decorator
from gingerdj.utils.functional import LazyObject
...
from gingerdj.views.i18n import JavaScriptCatalog
...
class AdminSite:
    """
    An AdminSite object encapsulates an instance of the GingerDJ admin application, ready
    to be hooked in to your URLconf. Models are registered with the AdminSite using the
    register() method, and the get_urls() method can then be used to access GingerDJ view
    functions that present a full admin interface for the collection of registered
    models.
    """

    # Text to put at the end of each page's <title>.
    site_title = gettext_lazy("GingerDJ site admin")

    # Text to put in each page's <div id="site-name">.
    site_header = gettext_lazy("GingerDJ administration")
    ...
    def i18n_javascript(self, request, extra_context=None):
        """
        Display the i18n JavaScript that the GingerDJ admin requires.

        `extra_context` is unused but present for consistency with the other
        admin views.
        """
        return JavaScriptCatalog.as_view(packages=["gingerdj.contrib.admin"])(request)
