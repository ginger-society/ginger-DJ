...
from gingerdj.forms.utils import flatatt
from gingerdj.template.defaultfilters import capfirst, linebreaksbr
from gingerdj.urls import NoReverseMatch, reverse
from gingerdj.utils.html import conditional_escape, format_html
...
class Fieldline:
    def __init__(self, form, field, readonly_fields=None, model_admin=None):
        self.form = form  # A gingerdj.forms.Form instance
...
class AdminField:
    def __init__(self, form, field, is_first):
        self.field = form[field]  # A gingerdj.forms.BoundField instance
...
class InlineAdminForm(AdminForm):
    ...
    def deletion_field(self):
        from gingerdj.forms.formsets import DELETION_FIELD_NAME
