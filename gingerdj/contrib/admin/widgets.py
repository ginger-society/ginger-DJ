"""
Form Widget classes specific to the GingerDJ admin site.
"""
...
from gingerdj.core.validators import URLValidator
from gingerdj.db.models import CASCADE, UUIDField
from gingerdj.urls import reverse
from gingerdj.urls.exceptions import NoReverseMatch
from gingerdj.utils.html import smart_urlquote
from gingerdj.utils.http import urlencode
from gingerdj.utils.text import Truncator
...
class ForeignKeyRawIdWidget(forms.TextInput):
    ...
    def url_parameters(self):
        from gingerdj.contrib.admin.views.main import TO_FIELD_VAR
...
class RelatedFieldWidgetWrapper(forms.Widget):
    ...
    def get_context(self, name, value, attrs):
        from gingerdj.contrib.admin.views.main import IS_POPUP_VAR, TO_FIELD_VAR
...
# Mapping of lowercase language codes [returned by GingerDJ's get_language()] to
# language codes supported by select2.
# See gingerdj/contrib/admin/static/admin/js/vendor/select2/i18n/*
