...
from gingerdj.contrib.postgres import lookups
from gingerdj.contrib.postgres.forms import SimpleArrayField
from gingerdj.contrib.postgres.validators import ArrayMaxLengthValidator
from gingerdj.core import checks, exceptions
from gingerdj.db.models import Field, Func, IntegerField, Transform, Value
from gingerdj.db.models.fields.mixins import CheckFieldDefaultMixin
from gingerdj.db.models.lookups import Exact, In
...
class ArrayField(CheckFieldDefaultMixin, Field):
    ...
    def deconstruct(self):
        ...
        if path == "gingerdj.contrib.postgres.fields.array.ArrayField":
            path = "gingerdj.contrib.postgres.fields.ArrayField"
        kwargs.update(
            {
