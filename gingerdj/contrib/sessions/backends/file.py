...
from gingerdj.contrib.sessions.backends.base import (
    VALID_KEY_CHARS,
    CreateError,
    SessionBase,
    UpdateError,
)
from gingerdj.contrib.sessions.exceptions import InvalidSessionKey
from gingerdj.core.exceptions import ImproperlyConfigured, SuspiciousOperation
        ...
        try:
            ...
            if not os.path.isdir(storage_path):
                raise ImproperlyConfigured(
                    ...
                    " GingerDJ can store session data." % storage_path
                )
                ...
                try:
                    ...
                    if isinstance(e, SuspiciousOperation):
                        logger = logging.getLogger(
                            "gingerdj.security.%s" % e.__class__.__name__
                        )
