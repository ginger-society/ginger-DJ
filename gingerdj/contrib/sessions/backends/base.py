...
class UpdateError(Exception):
    """
    Occurs if GingerDJ tries to update a session that was deleted.
    """
...
class SessionBase:
    ...
    @property
    def key_salt(self):
        return "gingerdj.contrib.sessions." + self.__class__.__qualname__
    ...
    def decode(self, session_data):
        try:
            ...
            logger = logging.getLogger("gingerdj.security.SuspiciousSession")
