...
from gingerdj.contrib.gis import forms, gdal
from gingerdj.contrib.gis.db.models.proxy import SpatialProxy
...
from gingerdj.db.models import Field
...
def get_srid_info(srid, connection):
    ...
    """
    from gingerdj.contrib.gis.gdal import SpatialReference
...
class RasterField(BaseSpatialField):
    """
    Raster field for GeoGinger -- evaluates into GDALRaster objects.
    """
    ...
    def get_transform(self, name):
        from gingerdj.contrib.gis.db.models.lookups import RasterBandTransform
