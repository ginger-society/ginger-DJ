...
from gingerdj.contrib.gis.db.models import GeometryField, RasterField
from gingerdj.contrib.gis.gdal import GDALRaster
from gingerdj.contrib.gis.geos.geometry import GEOSGeometryBase
...
from gingerdj.db import NotSupportedError, ProgrammingError
...
from gingerdj.db.models import Func, Value
        ...
        if hasattr(settings, "POSTGIS_VERSION"):
            ...
            try:
                ...
                raise ImproperlyConfigured(
                    ...
                    "GeoGinger requires at least PostGIS version 3.0. "
