...
from gingerdj.contrib.gis.db.backends.oracle.adapter import OracleSpatialAdapter
...
from gingerdj.db.backends.oracle.operations import DatabaseOperations
...
class OracleOperations(BaseSpatialOperations, DatabaseOperations):
    ...
    def geometry_columns(self):
        from gingerdj.contrib.gis.db.backends.oracle.models import OracleGeometryColumns

        return OracleGeometryColumns

    def spatial_ref_sys(self):
        from gingerdj.contrib.gis.db.backends.oracle.models import OracleSpatialRefSys
