...
from gingerdj.contrib.gis.db.backends.base.operations import BaseSpatialOperations
from gingerdj.contrib.gis.db.backends.spatialite.adapter import SpatiaLiteAdapter
from gingerdj.contrib.gis.db.backends.utils import SpatialOperator
from gingerdj.contrib.gis.geos.geometry import GEOSGeometry, GEOSGeometryBase
from gingerdj.contrib.gis.geos.prototypes.io import wkb_r
from gingerdj.contrib.gis.measure import Distance
from gingerdj.core.exceptions import ImproperlyConfigured
from gingerdj.db.backends.sqlite3.operations import DatabaseOperations
...
class SpatiaLiteOperations(BaseSpatialOperations, DatabaseOperations):
    ...
    def spatial_version(self):
        ...
        if version < (4, 3, 0):
            raise ImproperlyConfigured("GeoGinger supports SpatiaLite 4.3.0 and above.")
        return version
    ...
    def geometry_columns(self):
        from gingerdj.contrib.gis.db.backends.spatialite.models import (
