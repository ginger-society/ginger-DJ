...
from gingerdj.contrib.gis.measure import Area as AreaMeasure
from gingerdj.contrib.gis.measure import Distance as DistanceMeasure
...
class BaseSpatialOperations:
    ...
    # Mapping between GingerDJ function names and backend names, when names do not
