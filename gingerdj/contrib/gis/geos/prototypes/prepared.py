...
from gingerdj.contrib.gis.geos.libgeos import GEOM_PTR, PREPGEOM_PTR, GEOSFuncFactory
from gingerdj.contrib.gis.geos.prototypes.errcheck import check_predicate
