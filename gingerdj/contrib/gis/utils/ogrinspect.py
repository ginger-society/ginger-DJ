...
models for GeoGinger and/or mapping dictionaries for use with the
...
def ogrinspect(*args, **kwargs):
    ...
    model name this function will generate a GeoGinger model.

    Usage:

    >>> from gingerdj.contrib.gis.utils import ogrinspect
    ...
    Optional Keyword Arguments
     ...
     `imports` => Boolean (default: True) - set to False to omit the
       `from gingerdj.contrib.gis.db import models` code from the
...
def _ogrinspect(
    ...
    """
    Helper routine for `ogrinspect` that generates GeoGinger models corresponding
    ...
    if imports:
        yield "# This is an auto-generated GingerDJ model module created by ogrinspect."
        yield "from gingerdj.contrib.gis.db import models"
        yield ""
        yield ""
