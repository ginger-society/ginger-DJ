...
from gingerdj.contrib.gis.gdal.envelope import OGREnvelope
from gingerdj.contrib.gis.gdal.libgdal import GDAL_VERSION, lgdal
from gingerdj.contrib.gis.gdal.prototypes.errcheck import check_envelope
from gingerdj.contrib.gis.gdal.prototypes.generation import (
    bool_output,
    const_string_output,
    double_output,
    geom_output,
