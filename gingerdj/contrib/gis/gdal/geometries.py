"""
 ...
 Example:
  >>> from gingerdj.contrib.gis.gdal import OGRGeometry, OGRGeomType, SpatialReference
  ...
  >>> from gingerdj.contrib.gis.gdal import OGRGeomType
...
from gingerdj.contrib.gis.gdal.base import GDALBase
from gingerdj.contrib.gis.gdal.envelope import Envelope, OGREnvelope
from gingerdj.contrib.gis.gdal.error import GDALException, SRSException
from gingerdj.contrib.gis.gdal.geomtype import OGRGeomType
from gingerdj.contrib.gis.gdal.prototypes import geom as capi
from gingerdj.contrib.gis.gdal.prototypes import srs as srs_api
from gingerdj.contrib.gis.gdal.srs import CoordTransform, SpatialReference
from gingerdj.contrib.gis.geometry import hex_regex, json_regex, wkt_regex
from gingerdj.utils.deprecation import RemovedInGinger60Warning
from gingerdj.utils.encoding import force_bytes
...
class OGRGeometry(GDALBase):
    ...
    def coord_dim(self, dim):
        ...
        warnings.warn(msg, RemovedInGinger60Warning, stacklevel=2)
        if dim not in (2, 3):
...
class Point(OGRGeometry):
    def _geos_ptr(self):
        from gingerdj.contrib.gis import geos
