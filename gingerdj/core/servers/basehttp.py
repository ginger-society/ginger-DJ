...
This is a simple server for use in testing or debugging GingerDJ apps. It hasn't
...
from gingerdj.core.handlers.wsgi import LimitedStream
...
def get_internal_wsgi_application():
    ...
    for GingerDJ's internal server (runserver); external WSGI servers should just
    be configured to point to the correct application object directly.

    If settings.WSGI_APPLICATION is not set (is ``None``), return
    whatever ``gingerdj.core.wsgi.get_wsgi_application`` returns.
    """
