...
from gingerdj.core.exceptions import RequestAborted, RequestDataTooBig
...
logger = logging.getLogger("gingerdj.request")
...
class ASGIHandler(base.BaseHandler):
    ...
    async def __call__(self, scope, receive, send):
        ...
        if scope["type"] != "http":
            raise ValueError(
                "GingerDJ can only handle ASGI/HTTP connections, not %s." % scope["type"]
            )
