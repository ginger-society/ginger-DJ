...
from gingerdj.db import DEFAULT_DB_ALIAS, connections, migrations
from gingerdj.db.migrations.loader import AmbiguityError, MigrationLoader
        ...
        for smigration in migrations_to_squash:
            if smigration.replaces:
                raise CommandError(
                    ...
                    "normal migration first: https://docs.gingerdj.gloportal.dev/en/%s/"
