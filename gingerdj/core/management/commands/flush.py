...
from gingerdj.core.management.sql import emit_post_migrate_signal, sql_flush
...
class Command(BaseCommand):
    ...
    def handle(self, **options):
        ...
        # The following are stealth options used by GingerDJ's internals.
        ...
        if confirm == "yes":
            try:
                ...
                raise CommandError(
                    ...
                    "  * The SQL was invalid.\n"
                    "Hint: Look at the output of 'gingerdj-admin sqlflush'. "
