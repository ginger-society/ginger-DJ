...
class Command(BaseCommand):
    help = """Displays differences between the current settings.py and GingerDJ's
    default settings."""
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            help=(
                ...
                "empty to compare against GingerDJ's default settings."
            ),
        )
        parser.add_argument(
            "--output",
    ...
    def handle(self, **options):
        from gingerdj.conf import Settings, global_settings, settings
