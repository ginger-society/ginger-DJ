...
from gingerdj.core.management.utils import get_command_line_option
from gingerdj.test.runner import get_max_test_processes
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--testrunner",
            help="Tells GingerDJ to use specified test runner class instead of "
