...
from gingerdj.core.management.utils import run_formatters
from gingerdj.db import DEFAULT_DB_ALIAS, OperationalError, connections, router
from gingerdj.db.migrations import Migration
...
from gingerdj.db.migrations.migration import SwappableTuple
...
from gingerdj.db.migrations.utils import get_migration_name_timestamp
    ...
    def handle(self, *app_labels, **options):
        ...
        for alias in sorted(aliases_to_check):
            ...
            if connection.settings_dict[
                "ENGINE"
            ] != "gingerdj.db.backends.dummy" and any(
