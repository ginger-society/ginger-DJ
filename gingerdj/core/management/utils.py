...
from gingerdj.apps import apps as installed_apps
from gingerdj.utils.crypto import get_random_string
from gingerdj.utils.encoding import DEFAULT_LOCALE_ENCODING
...
def handle_extensions(extensions):
    ...
    For example: running 'gingerdj-admin makemessages -e js,txt -e xhtml -a'
