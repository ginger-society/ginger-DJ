...
class TemplateCommand(BaseCommand):
    """
    Copy either a GingerDJ application layout template or a GingerDJ project
    layout template into the specified directory.

    :param style: A color style object (see gingerdj.core.management.color).
    ...
    def handle(self, app_or_project, name, target=None, **options):
        ...
        context = Context(
            {
                **options,
                ...
                "ginger_version": gingerdj.__version__,
            },
            autoescape=False,
        )
        ...
        for root, dirs, files in os.walk(template_dir):
            ...
            for filename in files:
                ...
                # accidentally render GingerDJ templates files
    ...
    def handle_template(self, template, subdir):
        ...
        Use gingerdj.__path__[0] as the default because the GingerDJ install
        directory isn't known.
        """
        if template is None:
            return os.path.join(gingerdj.__path__[0], "conf", subdir)
        else:
    ...
    def download(self, url):
        ...
        prefix = "gingerdj_%s_template_" % self.app_or_project
        ...
        opener = build_opener()
        opener.addheaders = [("User-Agent", f"GingerDJ/{gingerdj.__version__}")]
        try:
