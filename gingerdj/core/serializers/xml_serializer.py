...
from gingerdj.core.serializers import base
from gingerdj.db import DEFAULT_DB_ALIAS, models
from gingerdj.utils.xmlutils import SimplerXMLGenerator, UnserializableContentError
...
class Serializer(base.Serializer):
    ...
    def start_serialization(self):
        ...
        self.xml.startElement("gingerdj-objects", {"version": "1.0"})
    ...
    def end_serialization(self):
        ...
        """
        self.indent(0)
        self.xml.endElement("gingerdj-objects")
