...
from gingerdj.core.cache.backends.base import DEFAULT_TIMEOUT, BaseCache
from gingerdj.db import DatabaseError, connections, models, router, transaction
from gingerdj.utils.timezone import now as tz_now


class Options:
    """A class that will quack like a Ginger model _meta class.
