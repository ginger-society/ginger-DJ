...
SECRET_KEY_INSECURE_PREFIX = "gingerdj-insecure-"
...
SECRET_KEY_WARNING_MSG = (
    ...
    f"automatically by GingerDJ. Please generate a long and random value, "
    f"otherwise many of GingerDJ's security-critical features will be "
    f"vulnerable to attack."
)

W001 = Warning(
    "You do not have 'gingerdj.middleware.security.SecurityMiddleware' "
...
W002 = Warning(
    "You do not have "
    "'gingerdj.middleware.clickjacking.XFrameOptionsMiddleware' in your "
...
def _security_middleware():
    return "gingerdj.middleware.security.SecurityMiddleware" in settings.MIDDLEWARE
