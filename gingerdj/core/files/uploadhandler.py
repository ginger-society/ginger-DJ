...
from gingerdj.core.files.uploadedfile import InMemoryUploadedFile, TemporaryUploadedFile
...
class StopUpload(UploadFileException):
    ...
    def __init__(self, connection_reset=False):
        """
        If ``connection_reset`` is ``True``, GingerDJ knows will halt the upload
