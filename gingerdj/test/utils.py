...
from gingerdj.conf import UserSettingsHolder, settings
from gingerdj.core import mail
from gingerdj.core.exceptions import ImproperlyConfigured
from gingerdj.core.signals import request_started, setting_changed
from gingerdj.db import DEFAULT_DB_ALIAS, connections, reset_queries
from gingerdj.db.models.options import Options
from gingerdj.template import Template
from gingerdj.test.signals import template_rendered
from gingerdj.urls import get_script_prefix, set_script_prefix
from gingerdj.utils.translation import deactivate
...
def setup_test_environment(debug=None):
    ...
    settings.EMAIL_BACKEND = "gingerdj.core.mail.backends.locmem.EmailBackend"
...
class override_settings(TestContextDecorator):
    ...
    def decorate_class(self, cls):
        ...
        if not issubclass(cls, SimpleTestCase):
            raise ValueError(
                "Only subclasses of GingerDJ SimpleTestCase can be decorated "
...
class override_system_checks(TestContextDecorator):
    ...
    def __init__(self, new_checks, deployment_checks=None):
        from gingerdj.core.checks.registry import registry
...
def require_jinja2(test_func):
    ...
    GingerDJ template engine for a test or skip it if Jinja2 isn't available.
    """
    ...
    return override_settings(
        TEMPLATES=[
            ...
            {
                "BACKEND": "gingerdj.template.backends.jinja2.Jinja2",
                "APP_DIRS": True,
...
class LoggingCaptureMixin:
    """
    Capture the output from the 'gingerdj' logger and store it on the class's
    logger_output attribute.
    """

    def setUp(self):
        self.logger = logging.getLogger("gingerdj")
