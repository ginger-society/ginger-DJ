...
from gingerdj.core.exceptions import ImproperlyConfigured, ValidationError
from gingerdj.core.files import locks
from gingerdj.core.handlers.wsgi import WSGIHandler, get_path_info
from gingerdj.core.management import call_command
from gingerdj.core.management.color import no_style
from gingerdj.core.management.sql import emit_post_migrate_signal
from gingerdj.core.servers.basehttp import ThreadedWSGIServer, WSGIRequestHandler
...
from gingerdj.db.backends.base.base import NO_DB_ALIAS, BaseDatabaseWrapper
from gingerdj.forms.fields import CharField
from gingerdj.http import QueryDict
from gingerdj.http.request import split_domain_port, validate_host
from gingerdj.test.client import AsyncClient, Client
from gingerdj.test.html import HTMLParseError, parse_html
from gingerdj.test.signals import template_rendered
...
from gingerdj.utils.functional import classproperty
from gingerdj.utils.version import PY311
from gingerdj.views.static import serve

logger = logging.getLogger("gingerdj.test")
...
class SimpleTestCase(unittest.TestCase):
    ...
    def __call__(self, result=None):
        """
        Wrapper around default __call__ method to perform common GingerDJ test
    ...
    def assertRedirects(
        ...
        if hasattr(response, "redirect_chain"):
            ...
            if fetch_redirect_response:
                # netloc might be empty, or in cases where GingerDJ tests the
                ...
                if domain and not validate_host(domain, settings.ALLOWED_HOSTS):
                    raise ValueError(
                        ...
                        "If the host is served by GingerDJ, add '%s' to ALLOWED_HOSTS. "
                        "Otherwise, use "
...
class TransactionTestCase(SimpleTestCase):
    ...
    # If transactions aren't available, GingerDJ will serialize the database
...
class FSFilesHandler(WSGIHandler):
    ...
    def serve(self, request):
        ...
        # Emulate behavior of gingerdj.contrib.staticfiles.views.serve() when it
