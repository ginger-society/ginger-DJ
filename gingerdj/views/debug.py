...
from gingerdj.http import Http404, HttpResponse, HttpResponseNotFound
from gingerdj.template import Context, Engine, TemplateDoesNotExist
from gingerdj.template.defaultfilters import pprint
...
from gingerdj.views.decorators.debug import coroutine_functions_to_sensitive_variables

# Minimal GingerDJ templates engine to render the error templates
    ...
    def get_exception_traceback_frames(self, exc_value, tb):
        ...
        while tb is not None:
            ...
            yield {
                ...
                "exc_cause_explicit": exc_cause_explicit,
                "tb": tb,
                "type": "gingerdj" if module_name.startswith("gingerdj.") else "user",
                "filename": filename,
                "function": function,
                "lineno": lineno + 1,
