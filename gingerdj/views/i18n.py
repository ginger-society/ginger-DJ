...
from gingerdj.urls import translate_url
from gingerdj.utils.formats import get_format
from gingerdj.utils.http import url_has_allowed_host_and_scheme
from gingerdj.utils.translation import check_for_language, get_language
from gingerdj.utils.translation.trans_real import GingerTranslation
...
class JavaScriptCatalog(View):
    ...
    a plus-sign delimited string from the request. Default is 'gingerdj.conf'.

    You can override the gettext domain for this view, but usually you don't
    want to do that as JavaScript messages go to the gingerjs domain. This
    might be needed if you deliver your JavaScript source from GingerDJ templates.
    """
    ...
    def get(self, request, *args, **kwargs):
        ...
        # GingerTranslation without localedirs harvests them all.
        packages = kwargs.get("packages", "")
        packages = packages.split("+") if packages else self.packages
        paths = self.get_paths(packages) if packages else None
        self.translation = GingerTranslation(locale, domain=domain, localedirs=paths)
