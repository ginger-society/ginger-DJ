...
from gingerdj.core.exceptions import DisallowedHost, ImproperlyConfigured
from gingerdj.http import HttpHeaders, UnreadablePostError
from gingerdj.urls import get_callable
from gingerdj.utils.cache import patch_vary_headers
from gingerdj.utils.crypto import constant_time_compare, get_random_string
from gingerdj.utils.deprecation import MiddlewareMixin
from gingerdj.utils.functional import cached_property
from gingerdj.utils.http import is_same_domain
from gingerdj.utils.log import log_response
from gingerdj.utils.regex_helper import _lazy_re_compile

logger = logging.getLogger("gingerdj.security.csrf")
...
class CsrfViewMiddleware(MiddlewareMixin):
    ...
    def _get_secret(self, request):
        ...
        if csrf_secret is None:
            return None
        # GingerDJ versions before 4.0 masked the secret before storing.
