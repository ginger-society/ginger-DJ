"""
Dummy database backend for GingerDJ.

GingerDJ uses this if the database ENGINE setting is empty (None or empty string).
...
from gingerdj.db.backends.dummy.features import DummyDatabaseFeatures
