...
from gingerdj.db import DatabaseError, NotSupportedError
from gingerdj.db.backends.base.operations import BaseDatabaseOperations
from gingerdj.db.backends.utils import split_tzname_delta, strip_quotes, truncate_name
from gingerdj.db.models import AutoField, Exists, ExpressionWrapper, Lookup
from gingerdj.db.models.expressions import RawSQL
from gingerdj.db.models.sql.where import WhereNode
...
/"""
    ...
    # https://groups.google.com/forum/#!msg/gingerdj-developers/zwQju7hbG78/9l934yelwfsJ
    ...
    def get_db_converters(self, expression):
        ...
        # string, undo this to adhere to the GingerDJ convention of using
    ...
    # DATE and TIMESTAMP columns, but GingerDJ wants to see a
        ...
        for param in returning_params:
            ...
            if value == []:
                raise DatabaseError(
                    ...
                    "https://code.gingerdj.gloportal.dev/ticket/28859)."
                )
    ...
    def sql_flush(self, style, tables, *, reset_sequences=False, allow_cascade=False):
        ...
        # keys which GingerDJ doesn't define. Emulate the PostgreSQL behavior
    ...
    def adapt_datetimefield_value(self, value):
        ...
        If naive datetime is passed assumes that is in UTC. Normally GingerDJ
