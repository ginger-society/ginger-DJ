from gingerdj.db import DatabaseError, InterfaceError
from gingerdj.db.backends.base.features import BaseDatabaseFeatures
from gingerdj.db.backends.oracle.oracledb_any import is_oracledb
...
class DatabaseFeatures(BaseDatabaseFeatures):
    ...
    ginger_test_expected_failures = {
        # A bug in GingerDJ/oracledb with respect to string handling (#23843).
