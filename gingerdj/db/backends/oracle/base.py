"""
Oracle database backend for GingerDJ.
...
from gingerdj.db.backends.oracle.oracledb_any import oracledb as Database
...
def wrap_oracle_errors():
    try:
        ...
        #            'ORA-02291: integrity constraint (TEST_GINGERTEST.SYS
        #               _C00102056) violated - parent key not found'
        #            or:
        #            'ORA-00001: unique constraint (GINGERTEST.DEFERRABLE_
        #               PINK_CONSTRAINT) violated
        # Convert that case to GingerDJ's IntegrityError exception.
        x = e.args[0]
        if (
            hasattr(x, "code")
...
class FormatStylePlaceholderCursor:
    """
    GingerDJ uses "format" (e.g. '%s') style placeholders, but Oracle uses ":var"
