"""
MySQL database backend for GingerDJ.
...
from gingerdj.db.backends import utils as backend_utils
...
# terms of actual behavior as they are signed and include days -- and GingerDJ
# expects time.
ginger_conversions = {
    **conversions,
...
class CursorWrapper:
    ...
    def execute(self, query, args=None):
        try:
            ...
            # misclassified and GingerDJ would prefer the more logical place.
...
class DatabaseWrapper(BaseDatabaseWrapper):
    ...
    def get_new_connection(self, conn_params):
        ...
        # prevent KeyErrors in GingerDJ < 2.0. We can remove this workaround when
        # mysqlclient 2.1 becomes the minimal mysqlclient supported by GingerDJ.
