...
from gingerdj.db.backends.utils import split_tzname_delta
from gingerdj.db.models import Exists, ExpressionWrapper, Lookup
...
class DatabaseOperations(BaseDatabaseOperations):
    compiler_module = "gingerdj.db.backends.mysql.compiler"
