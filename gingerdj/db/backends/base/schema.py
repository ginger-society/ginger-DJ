...
from gingerdj.db.backends.utils import names_digest, split_identifier, truncate_name
from gingerdj.db.models import NOT_PROVIDED, Deferrable, Index
...
logger = logging.getLogger("gingerdj.db.backends.schema")
...
class BaseDatabaseSchemaEditor:
    ...
    def _alter_field(
        ...
        # Drop the default if we need to
        # (GingerDJ usually does not use in-database defaults)
