...
class BaseDatabaseIntrospection:
    ...
    def get_field_type(self, data_type, description):
        ...
        match a GingerDJ field type to a database column.
    ...
    def ginger_table_names(self, only_existing=False, include_views=True):
        """
        Return a list of all table names that have associated GingerDJ models and
