from gingerdj.db import ProgrammingError
...
class BaseDatabaseFeatures:
    ...
    # SQL to create a procedure for use by the GingerDJ test suite. The
    # functionality of the procedure isn't important.
    create_test_procedure_without_params_sql = None
    create_test_procedure_with_int_param_sql = None

    # SQL to create a table with a composite primary key for use by the GingerDJ
    # test suite.
    ...
    # Collation names for use by the GingerDJ test suite.
    test_collations = {
    ...
    # A set of dotted paths to tests in GingerDJ's test suite that are expected
    # to fail on this database.
    ginger_test_expected_failures = set()
    # A map of reasons to sets of dotted paths to tests in GingerDJ's test suite
