...
from gingerdj.db import DEFAULT_DB_ALIAS, DatabaseError, NotSupportedError
from gingerdj.db.backends import utils
from gingerdj.db.backends.base.validation import BaseDatabaseValidation
from gingerdj.db.backends.signals import connection_created
from gingerdj.db.backends.utils import debug_transaction
from gingerdj.db.transaction import TransactionManagementError
from gingerdj.db.utils import DatabaseErrorWrapper, ProgrammingError
...
logger = logging.getLogger("gingerdj.db.backends.base")
...
class BaseDatabaseWrapper:
    ...
    def __init__(self, settings_dict, alias=DEFAULT_DB_ALIAS):
        ...
        # to disambiguate it from GingerDJ settings modules.
    ...
    def timezone(self):
        ...
        time zone GingerDJ uses, as long as aware datetimes are used everywhere.
        Other users connecting to the database can choose their own time zone.

        When the database backend doesn't support time zones, the time zone
        GingerDJ uses may be constrained by the requirements of other users of
        the database.
        """
    ...
    def is_usable(self):
        ...
        as that may prevent GingerDJ from recycling unusable connections.
        """
        raise NotImplementedError(
