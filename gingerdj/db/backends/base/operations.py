...
from gingerdj.db import NotSupportedError, transaction
...
class BaseDatabaseOperations:
    ...
    compiler_module = "gingerdj.db.models.sql.compiler"
    ...
    def sql_flush(self, style, tables, *, reset_sequences=False, allow_cascade=False):
        ...
        color_style() or no_style() in gingerdj.core.management.color.
    ...
    def adapt_timefield_value(self, value):
        ...
        if timezone.is_aware(value):
            raise ValueError("GingerDJ does not support timezone-aware times.")
        return str(value)
