"""
PostgreSQL database backend for GingerDJ.
...
from gingerdj.db import DatabaseError as WrappedDatabaseError
from gingerdj.db import connections
from gingerdj.db.backends.base.base import NO_DB_ALIAS, BaseDatabaseWrapper
from gingerdj.db.backends.utils import CursorDebugWrapper as BaseCursorDebugWrapper
...
class DatabaseWrapper(BaseDatabaseWrapper):
    ...
    def pool(self):
        ...
        if self.alias not in self._connection_pools:
            ...
            # Ensure we run in autocommit, GingerDJ properly sets it later on.
    ...
    def is_usable(self):
        if self.connection is None:
            return False
        try:
            # Use a psycopg cursor directly, bypassing GingerDJ's utilities.
    ...
    def _nodb_cursor(self):
        ...
        try:
            ...
            warnings.warn(
                ...
                "GingerDJ was unable to create a connection to the 'postgres' database "
