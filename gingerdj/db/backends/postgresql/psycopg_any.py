...
try:
    ...
    class GingerRangeDumper(RangeDumper):
        """A Range dumper customized for GingerDJ."""

        def upgrade(self, obj, format):
            # Dump ranges containing naive datetimes as tstzrange, because
            # GingerDJ doesn't use tz-aware ones.
    ...
    def get_adapters_template(use_tz, timezone):
        ...
        ctx.register_dumper(Range, GingerRangeDumper)
