...
5. Related objects manager for related instances on the forward or reverse
   ...
   Many-to-many relations are symmetrical. The syntax of GingerDJ models
...
from gingerdj.db.models import Manager, Q, Window, signals
from gingerdj.db.models.functions import RowNumber
from gingerdj.db.models.lookups import GreaterThan, LessThanOrEqual
from gingerdj.db.models.query import QuerySet
from gingerdj.db.models.query_utils import DeferredAttribute
from gingerdj.db.models.utils import AltersData, resolve_callables
...
def create_forward_many_to_many_manager(superclass, rel, reverse):
    ...
    class ManyRelatedManager(superclass, AltersData):
        ...
        def _get_target_ids(self, target_field_name, objs):
            ...
            """
            from gingerdj.db.models import Model
