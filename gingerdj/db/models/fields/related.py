...
from gingerdj.core import checks, exceptions
from gingerdj.db import connection, router
...
from gingerdj.db.models.deletion import CASCADE, SET_DEFAULT, SET_NULL
from gingerdj.db.models.query_utils import PathInfo
from gingerdj.db.models.utils import make_model_tuple
...
class ManyToManyField(RelatedField):
                ...
                if seen_self > 2 and not self.remote_field.through_fields:
                    errors.append(
                        checks.Error(
                            ...
                            "which two foreign keys GingerDJ should use via the "
                    ...
                    errors.append(
                        checks.Error(
                            (
                                ...
                                "which foreign key GingerDJ should use via the "
                                "through_fields keyword argument."
                            )
                            % (self, from_model_name),
                            hint=(
    ...
    def contribute_to_class(self, cls, name, **kwargs):
        ...
        if self.remote_field.symmetrical and (
            ...
            # related_name with one generated from the m2m field name. GingerDJ
