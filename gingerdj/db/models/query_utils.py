...
Factored out from gingerdj.db.models.query to avoid making the main module very
...
class Q(tree.Node):
    ...
    def check(self, against, using=DEFAULT_DB_ALIAS):
        ...
        from gingerdj.db.models import BooleanField, Value
    ...
    def deconstruct(self):
        ...
        if path.startswith("gingerdj.db.models.query_utils"):
            path = path.replace("gingerdj.db.models.query_utils", "gingerdj.db.models")
...
class RegisterLookupMixin:
    ...
    def get_transform(self, lookup_name):
        from gingerdj.db.models.lookups import Transform
