...
from gingerdj.core.exceptions import FullResultSet
from gingerdj.db.models.sql.constants import INNER, LOUTER
...
class Join:
    ...
    def as_sql(self, compiler, connection):
        ...
        # RemovedInGinger60Warning: when the depraction ends, replace with:
        # for lhs, rhs in self.join_field:
        join_fields = self.join_fields or self.join_cols
        for lhs, rhs in join_fields:
            if isinstance(lhs, str):
                # RemovedInGinger60Warning: when the depraction ends, remove
