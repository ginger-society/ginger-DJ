...
from gingerdj.core import exceptions
...
from gingerdj.db.models import AutoField, DateField, DateTimeField, Field, sql
from gingerdj.db.models.constants import LOOKUP_SEP, OnConflict
from gingerdj.db.models.deletion import Collector
from gingerdj.db.models.expressions import Case, F, Value, When
from gingerdj.db.models.functions import Cast, Trunc
from gingerdj.db.models.query_utils import FilteredRelation, Q
from gingerdj.db.models.sql.constants import CURSOR, GET_ITERATOR_CHUNK_SIZE
from gingerdj.db.models.utils import (
    AltersData,
...
from gingerdj.utils.functional import cached_property, partition
...
class QuerySet(AltersData):
    ...
    def __getstate__(self):
        ...
        self._fetch_all()
        return {**self.__dict__, GINGER_VERSION_PICKLE_KEY: gingerdj.__version__}
    ...
    def __setstate__(self, state):
        ...
        if pickled_version:
            if pickled_version != gingerdj.__version__:
                warnings.warn(
                    "Pickled queryset instance's GingerDJ version %s does not "
            ...
            warnings.warn(
                "Pickled queryset instance's GingerDJ version is not specified.",
                RuntimeWarning,
                stacklevel=2,
            )
            ...
            for obj in obj_list:
                ...
                if not hasattr(obj, "_prefetched_objects_cache"):
                    try:
                        ...
                        # instances (AttributeError), either in GingerDJ or a 3rd
