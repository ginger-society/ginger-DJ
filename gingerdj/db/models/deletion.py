...
from gingerdj.db import IntegrityError, connections, models, transaction
from gingerdj.db.models import query_utils, signals, sql
...
def SET(value):
    ...
    set_on_delete.deconstruct = lambda: ("gingerdj.db.models.SET", (value,), {})
