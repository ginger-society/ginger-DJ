...
from gingerdj.db.models import NOT_PROVIDED, ExpressionWrapper, IntegerField, Max, Value
from gingerdj.db.models.constants import LOOKUP_SEP
from gingerdj.db.models.deletion import CASCADE, Collector
...
from gingerdj.db.models.functions import Coalesce
from gingerdj.db.models.manager import Manager
from gingerdj.db.models.options import Options
from gingerdj.db.models.query import F, Q
from gingerdj.db.models.signals import (
    class_prepared,
    post_init,
    post_save,
    pre_init,
...
from gingerdj.db.models.utils import AltersData, make_model_tuple
from gingerdj.utils.deprecation import RemovedInGinger60Warning
from gingerdj.utils.encoding import force_str
from gingerdj.utils.hashable import make_hashable
from gingerdj.utils.text import capfirst, get_text_list
...
class ModelBase(type):
    ...
    def __new__(cls, name, bases, attrs, **kwargs):
        ...
        # Pass all attrs without a (GingerDJ-specific) contribute_to_class()
...
class Model(AltersData, metaclass=ModelBase):
    ...
    def __reduce__(self):
        ...
        data[GINGER_VERSION_PICKLE_KEY] = gingerdj.__version__
    ...
    def __setstate__(self, state):
        ...
        if pickled_version:
            if pickled_version != gingerdj.__version__:
                warnings.warn(
                    "Pickled model instance's GingerDJ version %s does not "
                    "match the current version %s."
                    % (pickled_version, gingerdj.__version__),
                    RuntimeWarning,
                    stacklevel=2,
                )
        else:
            warnings.warn(
                "Pickled model instance's GingerDJ version is not specified.",
                RuntimeWarning,
                stacklevel=2,
            )
            ...
            return [
                checks.Warning(
                    ...
                    hint=(
                        ...
                        f"of AutoField, e.g. 'gingerdj.db.models.BigAutoField'."
                    ),
                    obj=cls,
                    id="models.W042",
                ),
