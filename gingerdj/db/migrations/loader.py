...
class MigrationLoader:
    ...
    inherit from gingerdj.db.migrations.Migration. See
    gingerdj.db.migrations.migration for what that looks like.
            ...
            if exc.node in reverse_replacements:
                ...
                if not is_replaced:
                    ...
                    raise NodeNotFoundError(
                        ...
                        "GingerDJ tried to replace migration {1}.{2} with any of [{3}] "
