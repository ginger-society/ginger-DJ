...
from gingerdj.db.migrations.utils import field_is_referenced, get_references
from gingerdj.db.models import NOT_PROVIDED
from gingerdj.db.models.fields.related import RECURSIVE_RELATIONSHIP_CONSTANT
from gingerdj.db.models.options import DEFAULT_NAMES, normalize_together
...
class StateApps(Apps):
    ...
    def __init__(self, real_apps, models, ignore_swappable=False):
        ...
        # which is called whenever GingerDJ duplicates a StateApps before
        # updating it.
        self._lock = None
            ...
            while unrendered_models:
                ...
                if len(new_unrendered_models) == len(unrendered_models):
                    raise InvalidBasesError(
                        ...
                        "https://docs.gingerdj.gloportal.dev/en/%s/topics/migrations/"
...
class ModelState:
    """
    Represent a GingerDJ Model. Don't use the actual Model class as it's not
