...
from gingerdj.conf import SettingsReference
from gingerdj.db import models
from gingerdj.db.migrations.operations.base import Operation
from gingerdj.db.migrations.utils import COMPILED_REGEX_TYPE, RegexObject
from gingerdj.utils.functional import LazyObject, Promise
from gingerdj.utils.version import PY311, get_docs_version
...
class DeconstructableSerializer(BaseSerializer):
    ...
    def _serialize_path(path):
        ...
        if module == "gingerdj.db.models":
            imports = {"from gingerdj.db import models"}
            name = "models.%s" % name
        else:
...
class TypeSerializer(BaseSerializer):
    def serialize(self):
        special_cases = [
            (models.Model, "models.Model", ["from gingerdj.db import models"]),
...
def serializer_factory(value):
    ...
    raise ValueError(
        "Cannot serialize: %r\nThere are some values GingerDJ cannot serialize into "
        "migration files.\nFor more, see https://docs.gingerdj.gloportal.dev/en/%s/"
