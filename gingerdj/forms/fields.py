...
from gingerdj.forms.boundfield import BoundField
from gingerdj.forms.utils import from_current_timezone, to_current_timezone
...
from gingerdj.utils.dateparse import parse_datetime, parse_duration
...
from gingerdj.utils.translation import ngettext_lazy
...
class Field:
    ...
    def __init__(
        ...
        *,
        ...
        #          field in a form. By default, GingerDJ will use a "pretty"
        ...
        if assume_scheme is None:
            if settings.FORMS_URLFIELD_ASSUME_HTTPS:
                ...
                warnings.warn(
                    ...
                    "GingerDJ 6.0. Pass the forms.URLField.assume_scheme argument to "
