...
from gingerdj.utils.html import escape, format_html_join
...
class ErrorDict(dict, RenderableErrorMixin):
    ...
    template_name = "gingerdj/forms/errors/dict/default.html"
    template_name_text = "gingerdj/forms/errors/dict/text.txt"
    template_name_ul = "gingerdj/forms/errors/dict/ul.html"
...
class ErrorList(UserList, list, RenderableErrorMixin):
    ...
    template_name = "gingerdj/forms/errors/list/default.html"
    template_name_text = "gingerdj/forms/errors/list/text.txt"
    template_name_ul = "gingerdj/forms/errors/list/ul.html"
