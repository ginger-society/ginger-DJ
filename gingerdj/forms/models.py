"""
Helper functions for creating Form classes from GingerDJ models
...
from gingerdj.forms.fields import ChoiceField, Field
from gingerdj.forms.forms import BaseForm, DeclarativeFieldsMetaclass
from gingerdj.forms.formsets import BaseFormSet, formset_factory
from gingerdj.forms.utils import ErrorList
from gingerdj.forms.widgets import (
    HiddenInput,
    MultipleHiddenInput,
    RadioSelect,
    SelectMultiple,
)
from gingerdj.utils.choices import BaseChoiceIterator
...
def apply_limit_choices_to_to_formfield(formfield):
    ...
    from gingerdj.db.models import Exists, OuterRef, Q
...
def fields_for_model(
    ...
    *,
    ...
    from gingerdj.db.models import Field as ModelField
...
class BaseModelFormSet(BaseFormSet, AltersData):
    ...
    def get_queryset(self):
        if not hasattr(self, "_queryset"):
            ...
            # on gingerdj-dev, max_num should not prevent existing
    ...
    def add_fields(self, form, index):
        ...
        from gingerdj.db.models import AutoField, ForeignKey, OneToOneField
...
def modelformset_factory(
    ...
    """Return a FormSet class for the given GingerDJ model class."""
...
def _get_foreign_key(parent_model, model, fk_name=None, can_fail=False):
    ...
    """
    # avoid circular import
    from gingerdj.db.models import ForeignKey
