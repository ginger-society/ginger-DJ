...
from gingerdj.rest_framework import serializers, status
from gingerdj.rest_framework.mixins import (
    DestroyModelMixin,
    ListModelMixin,
    RetrieveModelMixin,
    UpdateModelMixin,
)
from gingerdj.rest_framework.parsers import FileUploadParser
