...
from gingerdj.utils.cache import add_never_cache_headers
from gingerdj.views.decorators.cache import cache_page
from gingerdj.views.decorators.vary import vary_on_headers
from gingerdj.rest_framework import exceptions
from gingerdj.rest_framework.response import Response
from gingerdj.rest_framework.settings import api_settings
from gingerdj.rest_framework.views import APIView
...
def get_schema_view(
    ...
    class SchemaView(APIView):
        ...
        def as_cached_view(cls, cache_timeout=0, cache_kwargs=None, **initkwargs):
            ...
            See https://docs.gingersociety.org/en/dev/topics/cache/
