...
from gingerdj.rest_framework.settings import api_settings as rest_framework_settings
...
from gingerdj.rest_framework import VERSION as drf_version
...
try:
    from gingerdj.rest_framework_recursive.fields import RecursiveField
except ImportError:  # pragma: no cover
