...
from ginger.core import signals, signing
from ginger.core.exceptions import DisallowedRedirect
from ginger.core.serializers.json import GingerJSONEncoder
from ginger.http.cookie import SimpleCookie
from ginger.utils import timezone
from ginger.utils.datastructures import CaseInsensitiveMapping
from ginger.utils.encoding import iri_to_uri
from ginger.utils.http import content_disposition_header, http_date
...
class JsonResponse(HttpResponse):
    ...
    :param encoder: Should be a json encoder class. Defaults to
      ``ginger.core.serializers.json.GingerJSONEncoder``.
