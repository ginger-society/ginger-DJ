...
from ginger.core.files import uploadhandler
...
from ginger.utils.encoding import escape_uri_path, iri_to_uri
from ginger.utils.functional import cached_property
from ginger.utils.http import is_same_domain, parse_header_parameters
...
class QueryDict(MultiValueDict):
    ...
    def __init__(self, query_string=None, mutable=False, encoding=None):
        ...
        try:
            ...
            # parse_qsl() is True. As that is not used by Ginger, assume that
...
# ginger.utils.encoding.force_str() for parsing URLs and form inputs. Thus,
