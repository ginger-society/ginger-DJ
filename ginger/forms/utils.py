...
from ginger.utils.html import escape, format_html_join
...
class ErrorDict(dict, RenderableErrorMixin):
    ...
    template_name = "ginger/forms/errors/dict/default.html"
    template_name_text = "ginger/forms/errors/dict/text.txt"
    template_name_ul = "ginger/forms/errors/dict/ul.html"
...
class ErrorList(UserList, list, RenderableErrorMixin):
    ...
    template_name = "ginger/forms/errors/list/default.html"
    template_name_text = "ginger/forms/errors/list/text.txt"
    template_name_ul = "ginger/forms/errors/list/ul.html"
