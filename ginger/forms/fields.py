...
from ginger.forms.boundfield import BoundField
from ginger.forms.utils import from_current_timezone, to_current_timezone
...
from ginger.utils.dateparse import parse_datetime, parse_duration
...
from ginger.utils.translation import ngettext_lazy
...
class Field:
    ...
    def __init__(
        ...
        *,
        ...
        #          field in a form. By default, Ginger will use a "pretty"
        ...
        if assume_scheme is None:
            if settings.FORMS_URLFIELD_ASSUME_HTTPS:
                ...
                warnings.warn(
                    ...
                    "Ginger 6.0. Pass the forms.URLField.assume_scheme argument to "
