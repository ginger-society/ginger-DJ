...
from ginger.db.models import AutoField, Manager, OrderWrt, UniqueConstraint
from ginger.db.models.query_utils import PathInfo
from ginger.utils.datastructures import ImmutableList, OrderedSet
from ginger.utils.functional import cached_property
from ginger.utils.module_loading import import_string
from ginger.utils.text import camel_case_to_spaces, format_lazy
...
class Options:
    ...
    def contribute_to_class(self, cls, name):
        ...
        if self.meta:
            ...
            for name in self.meta.__dict__:
                # Ignore any private attributes that Ginger doesn't care about.
    ...
    def fields(self):
        ...
        Private API intended only to be used by Ginger itself; get_fields()
    ...
    def _forward_fields_map(self):
        ...
        for field in fields:
            ...
            # Due to the way Ginger's internals work, get_field() should also
    ...
    def _get_fields(
        ...
        * The include_parents argument toggles if fields from parent models
        ...
        # implementation and to provide a fast way for Ginger's internals to
