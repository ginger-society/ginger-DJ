...
5. Related objects manager for related instances on the forward or reverse
   ...
   Many-to-many relations are symmetrical. The syntax of Ginger models
...
from ginger.db.models import Manager, Q, Window, signals
from ginger.db.models.functions import RowNumber
from ginger.db.models.lookups import GreaterThan, LessThanOrEqual
from ginger.db.models.query import QuerySet
from ginger.db.models.query_utils import DeferredAttribute
from ginger.db.models.utils import AltersData, resolve_callables
...
def create_forward_many_to_many_manager(superclass, rel, reverse):
    ...
    class ManyRelatedManager(superclass, AltersData):
        ...
        def _get_target_ids(self, target_field_name, objs):
            ...
            """
            from ginger.db.models import Model
