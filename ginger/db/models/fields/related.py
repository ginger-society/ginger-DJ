...
from ginger.core import checks, exceptions
from ginger.db import connection, router
from ginger.db.backends import utils
from ginger.db.models import Q
from ginger.db.models.constants import LOOKUP_SEP
from ginger.db.models.deletion import CASCADE, SET_DEFAULT, SET_NULL
from ginger.db.models.query_utils import PathInfo
from ginger.db.models.utils import make_model_tuple
...
class ManyToManyField(RelatedField):
                ...
                if seen_self > 2 and not self.remote_field.through_fields:
                    errors.append(
                        checks.Error(
                            ...
                            "which two foreign keys Ginger should use via the "
                    ...
                    errors.append(
                        checks.Error(
                            (
                                ...
                                "which foreign key Ginger should use via the "
                                "through_fields keyword argument."
                            )
                            % (self, from_model_name),
                            hint=(
    ...
    def contribute_to_class(self, cls, name, **kwargs):
        ...
        if self.remote_field.symmetrical and (
            ...
            # related_name with one generated from the m2m field name. Ginger
