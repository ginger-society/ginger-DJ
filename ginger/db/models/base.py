...
from ginger.db.models import NOT_PROVIDED, ExpressionWrapper, IntegerField, Max, Value
from ginger.db.models.constants import LOOKUP_SEP
from ginger.db.models.deletion import CASCADE, Collector
...
from ginger.db.models.functions import Coalesce
from ginger.db.models.manager import Manager
from ginger.db.models.options import Options
from ginger.db.models.query import F, Q
from ginger.db.models.signals import (
    class_prepared,
    post_init,
    post_save,
    pre_init,
...
from ginger.db.models.utils import AltersData, make_model_tuple
from ginger.utils.deprecation import RemovedInGinger60Warning
from ginger.utils.encoding import force_str
from ginger.utils.hashable import make_hashable
from ginger.utils.text import capfirst, get_text_list
...
class ModelBase(type):
    ...
    def __new__(cls, name, bases, attrs, **kwargs):
        ...
        # Pass all attrs without a (Ginger-specific) contribute_to_class()
...
class Model(AltersData, metaclass=ModelBase):
    ...
    def __reduce__(self):
        ...
        data[GINGER_VERSION_PICKLE_KEY] = ginger.__version__
    ...
    def __setstate__(self, state):
        pickled_version = state.get(GINGER_VERSION_PICKLE_KEY)
        if pickled_version:
            if pickled_version != ginger.__version__:
                warnings.warn(
                    "Pickled model instance's Ginger version %s does not "
                    "match the current version %s."
                    % (pickled_version, ginger.__version__),
                    RuntimeWarning,
                    stacklevel=2,
                )
        else:
            warnings.warn(
                "Pickled model instance's Ginger version is not specified.",
                RuntimeWarning,
                stacklevel=2,
            )
            ...
            return [
                checks.Warning(
                    ...
                    hint=(
                        ...
                        f"of AutoField, e.g. 'ginger.db.models.BigAutoField'."
                    ),
                    obj=cls,
                    id="models.W042",
                ),
