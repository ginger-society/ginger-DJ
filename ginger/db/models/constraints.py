...
from ginger.core.exceptions import FieldDoesNotExist, FieldError, ValidationError
from ginger.db import connections
from ginger.db.models.constants import LOOKUP_SEP
from ginger.db.models.expressions import Exists, ExpressionList, F, OrderBy, RawSQL
from ginger.db.models.indexes import IndexExpression
from ginger.db.models.lookups import Exact
from ginger.db.models.query_utils import Q
from ginger.db.models.sql.query import Query
from ginger.db.utils import DEFAULT_DB_ALIAS
...
class BaseConstraint:
    ...
    def deconstruct(self):
        ...
        path = path.replace("ginger.db.models.constraints", "ginger.db.models")
        ...
        *expressions,
        ...
        if expressions and opclasses:
            raise ValueError(
                ...
                "Use ginger.contrib.postgres.indexes.OpClass() instead."
            )
