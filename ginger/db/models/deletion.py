...
from ginger.db import IntegrityError, connections, models, transaction
from ginger.db.models import query_utils, signals, sql
...
def SET(value):
    ...
    set_on_delete.deconstruct = lambda: ("ginger.db.models.SET", (value,), {})
