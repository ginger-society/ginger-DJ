...
from ginger.core import exceptions
...
from ginger.db.models import AutoField, DateField, DateTimeField, Field, sql
from ginger.db.models.constants import LOOKUP_SEP, OnConflict
from ginger.db.models.deletion import Collector
from ginger.db.models.expressions import Case, F, Value, When
from ginger.db.models.functions import Cast, Trunc
from ginger.db.models.query_utils import FilteredRelation, Q
from ginger.db.models.sql.constants import CURSOR, GET_ITERATOR_CHUNK_SIZE
from ginger.db.models.utils import (
    AltersData,
...
from ginger.utils.functional import cached_property, partition
...
class QuerySet(AltersData):
    ...
    def __getstate__(self):
        ...
        self._fetch_all()
        return {**self.__dict__, GINGER_VERSION_PICKLE_KEY: ginger.__version__}
    ...
    def __setstate__(self, state):
        ...
        if pickled_version:
            if pickled_version != ginger.__version__:
                warnings.warn(
                    "Pickled queryset instance's Ginger version %s does not "
            ...
            warnings.warn(
                "Pickled queryset instance's Ginger version is not specified.",
                RuntimeWarning,
                stacklevel=2,
            )
            ...
            for obj in obj_list:
                ...
                if not hasattr(obj, "_prefetched_objects_cache"):
                    try:
                        ...
                        # instances (AttributeError), either in Ginger or a 3rd
