...
Factored out from ginger.db.models.query to avoid making the main module very
...
class Q(tree.Node):
    ...
    def check(self, against, using=DEFAULT_DB_ALIAS):
        ...
        from ginger.db.models import BooleanField, Value
    ...
    def deconstruct(self):
        ...
        if path.startswith("ginger.db.models.query_utils"):
            path = path.replace("ginger.db.models.query_utils", "ginger.db.models")
...
class RegisterLookupMixin:
    ...
    def get_transform(self, lookup_name):
        from ginger.db.models.lookups import Transform
