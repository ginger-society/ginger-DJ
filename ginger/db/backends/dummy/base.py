"""
Dummy database backend for Ginger.

Ginger uses this if the database ENGINE setting is empty (None or empty string).
...
from ginger.db.backends.dummy.features import DummyDatabaseFeatures
