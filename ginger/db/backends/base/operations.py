...
from ginger.db import NotSupportedError, transaction
...
class BaseDatabaseOperations:
    ...
    compiler_module = "ginger.db.models.sql.compiler"
    ...
    def sql_flush(self, style, tables, *, reset_sequences=False, allow_cascade=False):
        ...
        color_style() or no_style() in ginger.core.management.color.
    ...
    def adapt_timefield_value(self, value):
        ...
        if timezone.is_aware(value):
            raise ValueError("Ginger does not support timezone-aware times.")
        return str(value)
