...
from ginger.db import DEFAULT_DB_ALIAS, DatabaseError, NotSupportedError
from ginger.db.backends import utils
from ginger.db.backends.base.validation import BaseDatabaseValidation
from ginger.db.backends.signals import connection_created
from ginger.db.backends.utils import debug_transaction
from ginger.db.transaction import TransactionManagementError
from ginger.db.utils import DatabaseErrorWrapper, ProgrammingError
...
logger = logging.getLogger("ginger.db.backends.base")
...
class BaseDatabaseWrapper:
    ...
    def __init__(self, settings_dict, alias=DEFAULT_DB_ALIAS):
        ...
        # to disambiguate it from Ginger settings modules.
    ...
    def timezone(self):
        ...
        time zone Ginger uses, as long as aware datetimes are used everywhere.
        Other users connecting to the database can choose their own time zone.

        When the database backend doesn't support time zones, the time zone
        Ginger uses may be constrained by the requirements of other users of
        the database.
        """
    ...
    def is_usable(self):
        ...
        as that may prevent Ginger from recycling unusable connections.
        """
        raise NotImplementedError(
