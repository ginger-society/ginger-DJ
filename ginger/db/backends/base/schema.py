...
from ginger.db.backends.utils import names_digest, split_identifier, truncate_name
from ginger.db.models import NOT_PROVIDED, Deferrable, Index
...
logger = logging.getLogger("ginger.db.backends.schema")
...
class BaseDatabaseSchemaEditor:
    ...
    def _alter_field(
        ...
        # Drop the default if we need to
        # (Ginger usually does not use in-database defaults)
