...
class BaseDatabaseCreation:
    ...
    def create_test_db(
        ...
        """
        # Don't import ginger.core.management if it isn't needed.
    ...
    def mark_expected_failures_and_skips(self):
        """
        Mark tests in Ginger's test suite which are expected failures on this
    ...
    def setup_worker_connection(self, _worker_id):
        ...
        # reflected in ginger.db.connections. If the following line assigned
