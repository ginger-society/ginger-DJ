...
from ginger.db.backends.base.introspection import FieldInfo as BaseFieldInfo
from ginger.db.backends.base.introspection import TableInfo as BaseTableInfo
...
class DatabaseIntrospection(BaseDatabaseIntrospection):
    # Maps type codes to Ginger Field types.
    data_types_reverse = {
        16: "BooleanField",
        17: "BinaryField",
        20: "BigIntegerField",
    ...
    def get_field_type(self, data_type, description):
        ...
        if description.is_autofield or (
            # Required for pre-Ginger 4.1 serial columns.
            description.default
        ...
        for (
            ...
            if index not in constraints:
                basic_index = (
                    ...
                    and
                    # '_btree' references
                    # ginger.contrib.postgres.indexes.BTreeIndex.suffix.
