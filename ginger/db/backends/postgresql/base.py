"""
PostgreSQL database backend for Ginger.
...
from ginger.db import DatabaseError as WrappedDatabaseError
from ginger.db import connections
from ginger.db.backends.base.base import NO_DB_ALIAS, BaseDatabaseWrapper
from ginger.db.backends.utils import CursorDebugWrapper as BaseCursorDebugWrapper
...
class DatabaseWrapper(BaseDatabaseWrapper):
    ...
    def pool(self):
        ...
        if self.alias not in self._connection_pools:
            ...
            # Ensure we run in autocommit, Ginger properly sets it later on.
    ...
    def is_usable(self):
        if self.connection is None:
            return False
        try:
            # Use a psycopg cursor directly, bypassing Ginger's utilities.
    ...
    def _nodb_cursor(self):
        ...
        try:
            ...
            warnings.warn(
                ...
                "Ginger was unable to create a connection to the 'postgres' database "
