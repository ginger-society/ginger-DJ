"""
MySQL database backend for Ginger.
...
from ginger.db.backends import utils as backend_utils
...
# terms of actual behavior as they are signed and include days -- and Ginger
# expects time.
ginger_conversions = {
    **conversions,
...
class CursorWrapper:
    ...
    def execute(self, query, args=None):
        try:
            ...
            # misclassified and Ginger would prefer the more logical place.
...
class DatabaseWrapper(BaseDatabaseWrapper):
    ...
    def get_new_connection(self, conn_params):
        ...
        # prevent KeyErrors in Ginger < 2.0. We can remove this workaround when
        # mysqlclient 2.1 becomes the minimal mysqlclient supported by Ginger.
