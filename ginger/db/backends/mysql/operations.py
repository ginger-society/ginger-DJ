...
from ginger.db.backends.utils import split_tzname_delta
from ginger.db.models import Exists, ExpressionWrapper, Lookup
...
class DatabaseOperations(BaseDatabaseOperations):
    compiler_module = "ginger.db.backends.mysql.compiler"
