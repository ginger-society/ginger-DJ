...
from ginger.db import DatabaseError, NotSupportedError
from ginger.db.backends.base.operations import BaseDatabaseOperations
from ginger.db.backends.utils import split_tzname_delta, strip_quotes, truncate_name
from ginger.db.models import AutoField, Exists, ExpressionWrapper, Lookup
from ginger.db.models.expressions import RawSQL
from ginger.db.models.sql.where import WhereNode
...
/"""
    ...
    # https://groups.google.com/forum/#!msg/ginger-developers/zwQju7hbG78/9l934yelwfsJ
    ...
    def get_db_converters(self, expression):
        ...
        # string, undo this to adhere to the Ginger convention of using
    ...
    # DATE and TIMESTAMP columns, but Ginger wants to see a
        ...
        for param in returning_params:
            ...
            if value == []:
                raise DatabaseError(
                    ...
                    "https://code.ginger.gloportal.dev/ticket/28859)."
                )
    ...
    def sql_flush(self, style, tables, *, reset_sequences=False, allow_cascade=False):
        ...
        # keys which Ginger doesn't define. Emulate the PostgreSQL behavior
    ...
    def adapt_datetimefield_value(self, value):
        ...
        If naive datetime is passed assumes that is in UTC. Normally Ginger
