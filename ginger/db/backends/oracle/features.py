from ginger.db import DatabaseError, InterfaceError
from ginger.db.backends.base.features import BaseDatabaseFeatures
from ginger.db.backends.oracle.oracledb_any import is_oracledb
...
class DatabaseFeatures(BaseDatabaseFeatures):
    ...
    ginger_test_expected_failures = {
        # A bug in Ginger/oracledb with respect to string handling (#23843).
