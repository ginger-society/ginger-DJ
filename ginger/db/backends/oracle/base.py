"""
Oracle database backend for Ginger.
...
from ginger.db.backends.oracle.oracledb_any import oracledb as Database
...
def wrap_oracle_errors():
    try:
        ...
        # Convert that case to Ginger's IntegrityError exception.
        x = e.args[0]
        if (
            hasattr(x, "code")
...
class FormatStylePlaceholderCursor:
    """
    Ginger uses "format" (e.g. '%s') style placeholders, but Oracle uses ":var"
