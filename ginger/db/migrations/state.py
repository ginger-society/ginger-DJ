...
from ginger.db.migrations.utils import field_is_referenced, get_references
from ginger.db.models import NOT_PROVIDED
from ginger.db.models.fields.related import RECURSIVE_RELATIONSHIP_CONSTANT
from ginger.db.models.options import DEFAULT_NAMES, normalize_together
...
class StateApps(Apps):
    ...
    def __init__(self, real_apps, models, ignore_swappable=False):
        ...
        # which is called whenever Ginger duplicates a StateApps before
        # updating it.
        self._lock = None
            ...
            while unrendered_models:
                ...
                if len(new_unrendered_models) == len(unrendered_models):
                    raise InvalidBasesError(
                        ...
                        "https://docs.ginger.gloportal.dev/en/%s/topics/migrations/"
...
class ModelState:
    """
    Represent a Ginger Model. Don't use the actual Model class as it's not
