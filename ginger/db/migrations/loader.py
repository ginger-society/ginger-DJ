...
class MigrationLoader:
    ...
    inherit from ginger.db.migrations.Migration. See
    ginger.db.migrations.migration for what that looks like.
            ...
            if exc.node in reverse_replacements:
                ...
                if not is_replaced:
                    ...
                    raise NodeNotFoundError(
                        ...
                        "Ginger tried to replace migration {1}.{2} with any of [{3}] "
