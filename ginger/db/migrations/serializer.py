...
from ginger.conf import SettingsReference
from ginger.db import models
from ginger.db.migrations.operations.base import Operation
from ginger.db.migrations.utils import COMPILED_REGEX_TYPE, RegexObject
from ginger.utils.functional import LazyObject, Promise
...
class DeconstructableSerializer(BaseSerializer):
    ...
    def _serialize_path(path):
        ...
        if module == "ginger.db.models":
            imports = {"from ginger.db import models"}
            name = "models.%s" % name
        else:
...
class TypeSerializer(BaseSerializer):
    def serialize(self):
        special_cases = [
            (models.Model, "models.Model", ["from ginger.db import models"]),
...
def serializer_factory(value):
    ...
    raise ValueError(
        "Cannot serialize: %r\nThere are some values Ginger cannot serialize into "
        "migration files.\nFor more, see https://docs.ginger.gloportal.dev/en/%s/"
