...
from ginger.core.exceptions import DisallowedHost, ImproperlyConfigured
from ginger.http import HttpHeaders, UnreadablePostError
from ginger.urls import get_callable
from ginger.utils.cache import patch_vary_headers
from ginger.utils.crypto import constant_time_compare, get_random_string
from ginger.utils.deprecation import MiddlewareMixin
from ginger.utils.functional import cached_property
from ginger.utils.http import is_same_domain
from ginger.utils.log import log_response
from ginger.utils.regex_helper import _lazy_re_compile

logger = logging.getLogger("ginger.security.csrf")
...
class CsrfViewMiddleware(MiddlewareMixin):
    ...
    def _get_secret(self, request):
        ...
        if csrf_secret is None:
            return None
        # Ginger versions before 4.0 masked the secret before storing.
