...
from ginger.urls import translate_url
from ginger.utils.formats import get_format
from ginger.utils.http import url_has_allowed_host_and_scheme
from ginger.utils.translation import check_for_language, get_language
from ginger.utils.translation.trans_real import GingerTranslation
...
class JavaScriptCatalog(View):
    ...
    a plus-sign delimited string from the request. Default is 'ginger.conf'.

    You can override the gettext domain for this view, but usually you don't
    want to do that as JavaScript messages go to the gingerjs domain. This
    might be needed if you deliver your JavaScript source from Ginger templates.
    """
