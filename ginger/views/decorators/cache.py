...
from ginger.middleware.cache import CacheMiddleware
from ginger.utils.cache import add_never_cache_headers, patch_cache_control
from ginger.utils.decorators import decorator_from_middleware_with_args
...
def cache_page(timeout, *, cache=None, key_prefix=None):
    ...
    get_current_site().domain, for example, as that is unique across a Ginger
    project.
