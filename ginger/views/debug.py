...
from ginger.http import Http404, HttpResponse, HttpResponseNotFound
from ginger.template import Context, Engine, TemplateDoesNotExist
from ginger.template.defaultfilters import pprint
...
from ginger.utils.version import PY311, get_docs_version
from ginger.views.decorators.debug import coroutine_functions_to_sensitive_variables

# Minimal Ginger templates engine to render the error templates
...
class ExceptionReporter:
    ...
    def get_traceback_data(self):
        ...
        c = {
            ...
            "ginger_version_info": get_version(),
            "sys_path": sys.path,
    ...
    def get_exception_traceback_frames(self, exc_value, tb):
        ...
        while tb is not None:
            ...
            yield {
                ...
                "exc_cause_explicit": exc_cause_explicit,
                "tb": tb,
                "type": "ginger" if module_name.startswith("ginger.") else "user",
                "filename": filename,
                "function": function,
                "lineno": lineno + 1,
