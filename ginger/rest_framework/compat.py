...
# ginger.contrib.postgres requires psycopg2
try:
    from ginger.contrib.postgres import fields as postgres_fields
except ImportError:
...
if ginger.VERSION >= (5, 1):
    ...
    from ginger.core.validators import ip_address_validators
else:
    # Django <= 5.1: create a compatibility shim for ip_address_validators
    from ginger.core.validators import ip_address_validators as _ip_address_validators
