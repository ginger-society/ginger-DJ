...
from ginger.rest_framework import RemovedInDRF317Warning, exceptions, serializers
from ginger.rest_framework.compat import coreapi, coreschema, uritemplate
