...
from ginger.utils.decorators import classonlymethod
from ginger.views.decorators.csrf import csrf_exempt

from ginger.rest_framework import generics, mixins, views
from ginger.rest_framework.decorators import MethodMapper
