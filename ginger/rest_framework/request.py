...
from ginger.http import HttpRequest, QueryDict
from ginger.http.request import RawPostDataException
...
class Request:
    ...
    def __init__(
        ...
        assert isinstance(request, HttpRequest), (
            ...
            "`ginger.http.HttpRequest`, not `{}.{}`.".format(
    ...
    def user(self, value):
        ...
        compatibility with ginger.contrib.auth where the user property is
