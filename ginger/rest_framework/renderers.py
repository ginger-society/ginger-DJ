...
from ginger.core.paginator import Page
from ginger.template import engines, loader
from ginger.urls import NoReverseMatch
from ginger.utils.html import mark_safe
from ginger.utils.http import parse_header_parameters
from ginger.utils.safestring import SafeString

from ginger.rest_framework import VERSION, exceptions, serializers, status
from ginger.rest_framework.compat import (
    INDENT_SEPARATORS, LONG_SEPARATORS, SHORT_SEPARATORS, coreapi, coreschema,
    pygments_css, yaml
)
from ginger.rest_framework.exceptions import ParseError
from ginger.rest_framework.request import is_form_media_type, override_method
from ginger.rest_framework.settings import api_settings
from ginger.rest_framework.utils import encoders, json
from ginger.rest_framework.utils.breadcrumbs import get_breadcrumbs
from ginger.rest_framework.utils.field_mapping import ClassLookupDict
...
class MultiPartRenderer(BaseRenderer):
    ...
    def render(self, data, accepted_media_type=None, renderer_context=None):
        from ginger.test.client import encode_multipart
