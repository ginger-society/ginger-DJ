...
from ginger.core.handlers.asgi import ASGIRequest
from ginger.core.handlers.base import BaseHandler
...
from ginger.core.signals import got_request_exception, request_finished, request_started
from ginger.db import close_old_connections
from ginger.http import HttpHeaders, HttpRequest, QueryDict, SimpleCookie
from ginger.test import signals
...
class RequestFactory:
    ...
    def __init__(
        self,
        *,
        json_encoder=GingerJSONEncoder,
        headers=None,
        query_params=None,
        **defaults,
    ):
