...
from ginger.conf import UserSettingsHolder, settings
from ginger.core import mail
from ginger.core.exceptions import ImproperlyConfigured
from ginger.core.signals import request_started, setting_changed
from ginger.db import DEFAULT_DB_ALIAS, connections, reset_queries
from ginger.db.models.options import Options
from ginger.template import Template
from ginger.test.signals import template_rendered
from ginger.urls import get_script_prefix, set_script_prefix
from ginger.utils.translation import deactivate
...
def setup_test_environment(debug=None):
    ...
    settings.EMAIL_BACKEND = "ginger.core.mail.backends.locmem.EmailBackend"
...
class override_settings(TestContextDecorator):
    ...
    def decorate_class(self, cls):
        ...
        if not issubclass(cls, SimpleTestCase):
            raise ValueError(
                "Only subclasses of Ginger SimpleTestCase can be decorated "
...
class override_system_checks(TestContextDecorator):
    ...
    def __init__(self, new_checks, deployment_checks=None):
        from ginger.core.checks.registry import registry
...
def require_jinja2(test_func):
    ...
    Ginger template engine for a test or skip it if Jinja2 isn't available.
    """
...
class LoggingCaptureMixin:
    """
    Capture the output from the 'ginger' logger and store it on the class's
    logger_output attribute.
    """

    def setUp(self):
        self.logger = logging.getLogger("ginger")
