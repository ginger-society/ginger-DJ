...
from ginger.core.exceptions import ImproperlyConfigured, ValidationError
from ginger.core.files import locks
from ginger.core.handlers.wsgi import WSGIHandler, get_path_info
from ginger.core.management import call_command
from ginger.core.management.color import no_style
from ginger.core.management.sql import emit_post_migrate_signal
from ginger.core.servers.basehttp import ThreadedWSGIServer, WSGIRequestHandler
from ginger.core.signals import setting_changed
from ginger.db import DEFAULT_DB_ALIAS, connection, connections, transaction
from ginger.db.backends.base.base import NO_DB_ALIAS, BaseDatabaseWrapper
from ginger.forms.fields import CharField
from ginger.http import QueryDict
from ginger.http.request import split_domain_port, validate_host
from ginger.test.client import AsyncClient, Client
from ginger.test.html import HTMLParseError, parse_html
from ginger.test.signals import template_rendered
...
from ginger.utils.functional import classproperty
from ginger.utils.version import PY311
from ginger.views.static import serve

logger = logging.getLogger("ginger.test")
...
class SimpleTestCase(unittest.TestCase):
    ...
    def __call__(self, result=None):
        """
        Wrapper around default __call__ method to perform common Ginger test
    ...
    def assertRedirects(
        ...
        if hasattr(response, "redirect_chain"):
            ...
            if fetch_redirect_response:
                # netloc might be empty, or in cases where Ginger tests the
                ...
                if domain and not validate_host(domain, settings.ALLOWED_HOSTS):
                    raise ValueError(
                        ...
                        "If the host is served by Ginger, add '%s' to ALLOWED_HOSTS. "
                        "Otherwise, use "
...
class TransactionTestCase(SimpleTestCase):
    ...
    # If transactions aren't available, Ginger will serialize the database
...
class FSFilesHandler(WSGIHandler):
    ...
    def serve(self, request):
        ...
        # Emulate behavior of ginger.contrib.staticfiles.views.serve() when it
