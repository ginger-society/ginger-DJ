...
from ginger.utils.autoreload import autoreload_started, file_changed
...
# without having to first configure Ginger, and (2) if some other code creates
...
class Trans:
    ...
    def __getattr__(self, real_name):
        ...
        if settings.USE_I18N:
            ...
            from ginger.utils.translation import trans_null as trans
