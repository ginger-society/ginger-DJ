...
from ginger.template.base import Lexer, TokenType
...
def templatize(src, origin=None):
    """
    Turn a Ginger template into something that is understood by xgettext. It
    does so by translating the Ginger translation tags into standard gettext
