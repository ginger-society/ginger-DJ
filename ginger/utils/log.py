...
from ginger.core.mail import get_connection
from ginger.core.management.color import color_style
from ginger.utils.module_loading import import_string

request_logger = logging.getLogger("ginger.request")

# Default logging for Ginger. This sends an email to the site admins on every
