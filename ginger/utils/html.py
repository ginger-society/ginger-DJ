...
from ginger.utils.encoding import punycode
from ginger.utils.functional import Promise, keep_lazy, keep_lazy_text
from ginger.utils.http import RFC3986_GENDELIMS, RFC3986_SUBDELIMS
from ginger.utils.regex_helper import _lazy_re_compile
from ginger.utils.safestring import SafeData, SafeString, mark_safe
from ginger.utils.text import normalize_newlines
...
def conditional_escape(text):
    ...
    This function relies on the __html__ convention used both by Ginger's
...
def html_safe(klass):
    """
    A decorator that defines the __html__ method. This helps non-Ginger
