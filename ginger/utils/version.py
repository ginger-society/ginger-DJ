...
# should remain as long as the oldest supported Ginger version supports that
# Python version.
...
def get_complete_version(version=None):
    """
    Return a tuple of the ginger version. If version argument is non-empty,
    check for correctness of the tuple provided.
    """
    if version is None:
        from ginger import VERSION as version
    else:
