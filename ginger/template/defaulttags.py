...
from ginger.utils.html import conditional_escape, escape, format_html
from ginger.utils.lorem_ipsum import paragraphs, words
...
class SpacelessNode(Node):
    ...
    def render(self, context):
        from ginger.utils.html import strip_spaces_between_tags
...
def load(parser, token):
    ...
    ``ginger/templatetags/news/photos.py``::
