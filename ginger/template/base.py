"""
This is the Ginger template system.
...
from ginger.template.context import BaseContext
from ginger.utils.formats import localize
from ginger.utils.html import conditional_escape, escape
from ginger.utils.regex_helper import _lazy_re_compile
from ginger.utils.safestring import SafeData, SafeString, mark_safe
from ginger.utils.text import get_text_list, smart_split, unescape_string_literal
from ginger.utils.timezone import template_localtime
from ginger.utils.translation import gettext_lazy, pgettext_lazy
...
logger = logging.getLogger("ginger.template")
...
class Template:
    def __init__(self, template_string, origin=None, name=None, engine=None):
        ...
        # exactly one Ginger template engine is configured, use that engine.
...
class Parser:
    def __init__(self, tokens, libraries=None, builtins=None, origin=None):
        ...
        # should use a key to namespace any added data. The 'ginger' namespace
