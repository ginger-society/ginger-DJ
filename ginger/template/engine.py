...
class Engine:
    ...
    def __init__(
        ...
        if loaders is None:
            ...
            loaders = [("ginger.template.loaders.cached.Loader", loaders)]
        else:
            if app_dirs:
    ...
    def get_default():
        ...
        'Hello world!'
        """
        # Since Engine is imported in ginger.template and since
    ...
    def render_to_string(self, template_name, context=None):
        ...
        For use in Ginger's test suite.
        """
        if isinstance(template_name, (list, tuple)):
            t = self.select_template(template_name)
        else:
            t = self.get_template(template_name)
        # Ginger < 1.8 accepted a Context in `context` even though that's
