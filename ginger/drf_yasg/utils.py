...
from ginger.rest_framework import serializers, status
from ginger.rest_framework.mixins import DestroyModelMixin, ListModelMixin, RetrieveModelMixin, UpdateModelMixin
from ginger.rest_framework.parsers import FileUploadParser
