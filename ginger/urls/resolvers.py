...
from ginger.core.checks.urls import check_resolver
...
from ginger.utils.http import RFC3986_SUBDELIMS, escape_leading_slashes
from ginger.utils.regex_helper import _lazy_re_compile, normalize
...
def _route_to_regex(route, is_endpoint):
    ...
    and {'pk': <ginger.urls.converters.IntConverter>}.
    """
    parts = ["^"]
        ...
        if "(?P<" in route or route.startswith("^") or route.endswith("$"):
            warnings.append(
                Warning(
                    ...
                    "when migrating to ginger.urls.path().".format(self.describe()),
                    id="2_0.W001",
                )
            )
        return warnings
...
class URLResolver:
    ...
    def resolve_error_handler(self, view_type):
        ...
        if not callback:
            ...
            # ginger.conf.urls imports this file.
            from ginger.conf import urls
