...
from ginger.contrib.staticfiles import utils
from ginger.contrib.staticfiles.views import serve
from ginger.core.handlers.asgi import ASGIHandler
from ginger.core.handlers.exception import response_for_exception
...
class ASGIStaticFilesHandler(StaticFilesHandlerMixin, ASGIHandler):
    ...
    files, passing them off to Ginger's static file serving.
    """
