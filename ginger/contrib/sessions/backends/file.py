...
from ginger.contrib.sessions.backends.base import (
    VALID_KEY_CHARS,
    CreateError,
    SessionBase,
    UpdateError,
)
from ginger.contrib.sessions.exceptions import InvalidSessionKey
from ginger.core.exceptions import ImproperlyConfigured, SuspiciousOperation
        ...
        try:
            ...
            if not os.path.isdir(storage_path):
                raise ImproperlyConfigured(
                    ...
                    " Ginger can store session data." % storage_path
                )
                ...
                try:
                    ...
                    if isinstance(e, SuspiciousOperation):
                        logger = logging.getLogger(
                            "ginger.security.%s" % e.__class__.__name__
                        )
