...
from ginger.contrib.sessions.backends.base import CreateError, SessionBase, UpdateError
from ginger.core.exceptions import SuspiciousOperation
from ginger.db import DatabaseError, IntegrityError, router, transaction
...
class SessionStore(SessionBase):
    ...
    def get_model_class(cls):
        ...
        # ginger.contrib.sessions is not in INSTALLED_APPS.
    ...
    def _get_session_from_db(self):
        try:
            ...
            if isinstance(e, SuspiciousOperation):
                logger = logging.getLogger("ginger.security.%s" % e.__class__.__name__)
