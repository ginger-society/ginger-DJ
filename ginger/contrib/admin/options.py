...
from ginger.contrib.admin import helpers, widgets
from ginger.contrib.admin.checks import (
    BaseModelAdminChecks,
    InlineModelAdminChecks,
    ModelAdminChecks,
)
from ginger.contrib.admin.exceptions import DisallowedModelAdminToField, NotRegistered
...
from ginger.contrib.admin.widgets import AutocompleteSelect, AutocompleteSelectMultiple
...
from ginger.db import models, router, transaction
from ginger.db.models.constants import LOOKUP_SEP
from ginger.forms.formsets import DELETION_FIELD_NAME, all_valid
...
from ginger.forms.widgets import CheckboxSelectMultiple, SelectMultiple
from ginger.http import HttpResponseRedirect
from ginger.http.response import HttpResponseBase
from ginger.template.response import SimpleTemplateResponse, TemplateResponse
...
class BaseModelAdmin(metaclass=forms.MediaDefiningClass):
    ...
    def lookup_allowed(self, lookup, value, request=None):
        from ginger.contrib.admin.filters import SimpleListFilter
    ...
    def has_change_permission(self, request, obj=None):
        ...
        Ginger model instance, the default implementation doesn't examine the
        `obj` parameter.
...
class ModelAdmin(BaseModelAdmin):
    ...
    def log_addition(self, request, obj, message):
        ...
        """
        # from ginger.contrib.admin.models import ADDITION, LogEntry
    ...
    def log_deletion(self, request, obj, object_repr):
        ...
        # from ginger.contrib.admin.models import DELETION, LogEntry
    ...
    def message_user(
        ...
        posts a message using the ginger.contrib.messages backend.
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        """
        from ginger.contrib.admin.views.main import ERROR_FLAG
    ...
    def history_view(self, request, object_id, extra_context=None):
        ...
        from ginger.contrib.admin.views.main import PAGE_VAR
