...
from ginger.forms.utils import flatatt
from ginger.template.defaultfilters import capfirst, linebreaksbr
from ginger.urls import NoReverseMatch, reverse
from ginger.utils.html import conditional_escape, format_html
...
class Fieldline:
    def __init__(self, form, field, readonly_fields=None, model_admin=None):
        self.form = form  # A ginger.forms.Form instance
...
class AdminField:
    def __init__(self, form, field, is_first):
        self.field = form[field]  # A ginger.forms.BoundField instance
...
class InlineAdminForm(AdminForm):
    ...
    def deletion_field(self):
        from ginger.forms.formsets import DELETION_FIELD_NAME
