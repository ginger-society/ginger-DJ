"""
Form Widget classes specific to the Ginger admin site.
"""
...
from ginger.core.validators import URLValidator
from ginger.db.models import CASCADE, UUIDField
from ginger.urls import reverse
from ginger.urls.exceptions import NoReverseMatch
from ginger.utils.html import smart_urlquote
from ginger.utils.http import urlencode
from ginger.utils.text import Truncator
...
class ForeignKeyRawIdWidget(forms.TextInput):
    ...
    def url_parameters(self):
        from ginger.contrib.admin.views.main import TO_FIELD_VAR
...
class RelatedFieldWidgetWrapper(forms.Widget):
    ...
    def get_context(self, name, value, attrs):
        from ginger.contrib.admin.views.main import IS_POPUP_VAR, TO_FIELD_VAR
...
# Mapping of lowercase language codes [returned by Ginger's get_language()] to
# language codes supported by select2.
# See ginger/contrib/admin/static/admin/js/vendor/select2/i18n/*
