...
from ginger.forms.utils import pretty_name
from ginger.urls import NoReverseMatch, reverse
from ginger.utils import formats, timezone
...
from ginger.utils.translation import override as translation_override
...
def display_for_field(value, field, empty_value_display):
    from ginger.contrib.admin.templatetags.admin_list import _boolean_icon
...
def get_fields_from_path(model, path):
    ...
    e.g. (ModelX, "user__groups__name") -> [
        <ginger.db.models.fields.related.ForeignKey object at 0x...>,
        <ginger.db.models.fields.related.ManyToManyField object at 0x...>,
        <ginger.db.models.fields.CharField object at 0x...>,
    ]
    """
    pieces = path.split(LOOKUP_SEP)
    fields = []
