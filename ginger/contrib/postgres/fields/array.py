...
from ginger.contrib.postgres import lookups
from ginger.contrib.postgres.forms import SimpleArrayField
from ginger.contrib.postgres.validators import ArrayMaxLengthValidator
from ginger.core import checks, exceptions
from ginger.db.models import Field, Func, IntegerField, Transform, Value
from ginger.db.models.fields.mixins import CheckFieldDefaultMixin
from ginger.db.models.lookups import Exact, In
...
class ArrayField(CheckFieldDefaultMixin, Field):
    ...
    def deconstruct(self):
        ...
        if path == "ginger.contrib.postgres.fields.array.ArrayField":
            path = "ginger.contrib.postgres.fields.ArrayField"
        kwargs.update(
            {
