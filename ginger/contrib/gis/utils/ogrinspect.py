...
def ogrinspect(*args, **kwargs):
    ...
    >>> from ginger.contrib.gis.utils import ogrinspect
    ...
    Optional Keyword Arguments
     ...
     `imports` => Boolean (default: True) - set to False to omit the
       `from ginger.contrib.gis.db import models` code from the
...
def _ogrinspect(
    ...
    if imports:
        yield "# This is an auto-generated Ginger model module created by ogrinspect."
        yield "from ginger.contrib.gis.db import models"
        yield ""
        yield ""
