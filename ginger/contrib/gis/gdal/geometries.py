"""
 ...
 Example:
  >>> from ginger.contrib.gis.gdal import OGRGeometry, OGRGeomType, SpatialReference
  ...
  >>> from ginger.contrib.gis.gdal import OGRGeomType
...
from ginger.contrib.gis.gdal.base import GDALBase
from ginger.contrib.gis.gdal.envelope import Envelope, OGREnvelope
from ginger.contrib.gis.gdal.error import GDALException, SRSException
from ginger.contrib.gis.gdal.geomtype import OGRGeomType
from ginger.contrib.gis.gdal.prototypes import geom as capi
from ginger.contrib.gis.gdal.prototypes import srs as srs_api
from ginger.contrib.gis.gdal.srs import CoordTransform, SpatialReference
from ginger.contrib.gis.geometry import hex_regex, json_regex, wkt_regex
from ginger.utils.deprecation import RemovedInGinger60Warning
from ginger.utils.encoding import force_bytes
...
class Point(OGRGeometry):
    def _geos_ptr(self):
        from ginger.contrib.gis import geos
