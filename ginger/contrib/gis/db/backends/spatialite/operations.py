...
from ginger.contrib.gis.db.backends.base.operations import BaseSpatialOperations
from ginger.contrib.gis.db.backends.spatialite.adapter import SpatiaLiteAdapter
from ginger.contrib.gis.db.backends.utils import SpatialOperator
from ginger.contrib.gis.geos.geometry import GEOSGeometry, GEOSGeometryBase
from ginger.contrib.gis.geos.prototypes.io import wkb_r
from ginger.contrib.gis.measure import Distance
from ginger.core.exceptions import ImproperlyConfigured
from ginger.db.backends.sqlite3.operations import DatabaseOperations
...
class SpatiaLiteOperations(BaseSpatialOperations, DatabaseOperations):
    ...
    def geometry_columns(self):
        from ginger.contrib.gis.db.backends.spatialite.models import (
