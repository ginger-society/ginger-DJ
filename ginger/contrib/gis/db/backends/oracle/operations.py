...
from ginger.contrib.gis.db.backends.oracle.adapter import OracleSpatialAdapter
...
from ginger.db.backends.oracle.operations import DatabaseOperations
...
class OracleOperations(BaseSpatialOperations, DatabaseOperations):
    ...
    def geometry_columns(self):
        from ginger.contrib.gis.db.backends.oracle.models import OracleGeometryColumns

        return OracleGeometryColumns

    def spatial_ref_sys(self):
        from ginger.contrib.gis.db.backends.oracle.models import OracleSpatialRefSys
