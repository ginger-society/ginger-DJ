...
from ginger.contrib.gis.measure import Area as AreaMeasure
from ginger.contrib.gis.measure import Distance as DistanceMeasure
...
class BaseSpatialOperations:
    ...
    # Mapping between Ginger function names and backend names, when names do not
