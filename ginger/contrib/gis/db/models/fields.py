...
from ginger.contrib.gis import forms, gdal
from ginger.contrib.gis.db.models.proxy import SpatialProxy
...
from ginger.db.models import Field
...
def get_srid_info(srid, connection):
    ...
    """
    from ginger.contrib.gis.gdal import SpatialReference
...
class RasterField(BaseSpatialField):
    ...
    def get_transform(self, name):
        from ginger.contrib.gis.db.models.lookups import RasterBandTransform
