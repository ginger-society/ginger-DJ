...
from ginger.contrib.gis.geos import prototypes as capi
from ginger.contrib.gis.geos.base import GEOSBase
from ginger.contrib.gis.geos.coordseq import GEOSCoordSeq
from ginger.contrib.gis.geos.error import GEOSException
from ginger.contrib.gis.geos.libgeos import GEOM_PTR, geos_version_tuple
from ginger.contrib.gis.geos.mutable_list import ListMixin
from ginger.contrib.gis.geos.prepared import PreparedGeometry
from ginger.contrib.gis.geos.prototypes.io import ewkb_w, wkb_r, wkb_w, wkt_r, wkt_w
...
class GEOSGeometryBase(GEOSBase):
    ...
    def __deepcopy__(self, memodict):
        """
        The `deepcopy` routine is used by the `Node` class of ginger.utils.tree;
