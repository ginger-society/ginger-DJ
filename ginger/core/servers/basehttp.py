...
This is a simple server for use in testing or debugging Ginger apps. It hasn't
...
from ginger.core.handlers.wsgi import LimitedStream
...
def get_internal_wsgi_application():
    ...
    for Ginger's internal server (runserver); external WSGI servers should just
    be configured to point to the correct application object directly.

    If settings.WSGI_APPLICATION is not set (is ``None``), return
    whatever ``ginger.core.wsgi.get_wsgi_application`` returns.
    """
