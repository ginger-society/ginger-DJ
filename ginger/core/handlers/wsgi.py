...
from ginger.core import signals
from ginger.core.handlers import base
from ginger.http import HttpRequest, QueryDict, parse_cookie
from ginger.urls import set_script_prefix
from ginger.utils.encoding import repercent_broken_unicode
...
def get_bytes_from_wsgi(environ, key, default):
    ...
    # ISO-8859-1. This is wrong for Ginger websites where UTF-8 is the default.
