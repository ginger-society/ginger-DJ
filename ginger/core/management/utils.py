...
from ginger.apps import apps as installed_apps
from ginger.utils.crypto import get_random_string
from ginger.utils.encoding import DEFAULT_LOCALE_ENCODING
...
def handle_extensions(extensions):
    ...
    For example: running 'ginger-admin makemessages -e js,txt -e xhtml -a'
