...
class TemplateCommand(BaseCommand):
    """
    Copy either a Ginger application layout template or a Ginger project
    layout template into the specified directory.

    :param style: A color style object (see ginger.core.management.color).
    ...
    def handle(self, app_or_project, name, target=None, **options):
        ...
        context = Context(
            {
                **options,
                ...
                "ginger_version": ginger.__version__,
            },
            autoescape=False,
        )
        ...
        for root, dirs, files in os.walk(template_dir):
            ...
            for filename in files:
                ...
                # accidentally render Ginger templates files
    ...
    def handle_template(self, template, subdir):
        ...
        Use ginger.__path__[0] as the default because the Ginger install
        directory isn't known.
        """
        if template is None:
            return os.path.join(ginger.__path__[0], "conf", subdir)
        else:
    ...
    def download(self, url):
        ...
        prefix = "ginger_%s_template_" % self.app_or_project
        ...
        opener = build_opener()
        opener.addheaders = [("User-Agent", f"Ginger/{ginger.__version__}")]
        try:
