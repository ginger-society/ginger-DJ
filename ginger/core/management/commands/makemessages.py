...
from ginger.utils.jslex import prepare_js_for_gettext
from ginger.utils.regex_helper import _lazy_re_compile
from ginger.utils.text import get_text_list
from ginger.utils.translation import templatize
...
class Command(BaseCommand):
    help = (
        ...
        "conf/locale (in the ginger tree) or locale (for projects and applications) "
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            "-d",
            default="ginger",
            help='The domain of the message files (default: "ginger").',
        )
        parser.add_argument(
            "--all",
            "-a",
    ...
    def handle(self, *args, **options):
        ...
        if self.domain not in ("ginger", "gingerjs"):
            raise CommandError(
    ...
    def process_locale_dir(self, locale_dir, files):
        ...
        for translatable in files:
            ...
            if self.domain not in ("gingerjs", "ginger"):
                continue
    ...
    def copy_plural_forms(self, msgs, locale):
        """
        Copy plural forms header contents from a Ginger catalog of locale to
        the msgs string, inserting it at the right place. msgs should be the
        contents of a newly created .po file.
        """
        ginger_dir = os.path.normpath(os.path.join(os.path.dirname(ginger.__file__)))
        if self.domain == "gingerjs":
            domains = ("gingerjs", "ginger")
        else:
            domains = ("ginger",)
