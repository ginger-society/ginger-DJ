...
class Command(BaseCommand):
    help = (
        "Introspects the database tables in the given database and outputs a Ginger "
        "model module."
    )
    ...
    def handle_inspection(self, options):
        ...
        with connection.cursor() as cursor:
            yield "# This is an auto-generated Ginger model module."
            ...
            yield (
                ...
                "Ginger to create, modify, and delete the table"
            )
            yield (
