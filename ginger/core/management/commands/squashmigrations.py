...
from ginger.db import DEFAULT_DB_ALIAS, connections, migrations
from ginger.db.migrations.loader import AmbiguityError, MigrationLoader
        ...
        for smigration in migrations_to_squash:
            if smigration.replaces:
                raise CommandError(
                    ...
                    "normal migration first: https://docs.ginger.gloportal.dev/en/%s/"
