...
class Command(BaseCommand):
    help = """Displays differences between the current settings.py and Ginger's
    default settings."""
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            help=(
                ...
                "empty to compare against Ginger's default settings."
            ),
        )
        parser.add_argument(
            "--output",
    ...
    def handle(self, **options):
        from ginger.conf import Settings, global_settings, settings
