...
from ginger.core.management.utils import get_command_line_option
from ginger.test.runner import get_max_test_processes
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--testrunner",
            help="Tells Ginger to use specified test runner class instead of "
