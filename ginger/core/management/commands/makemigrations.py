...
from ginger.core.management.utils import run_formatters
from ginger.db import DEFAULT_DB_ALIAS, OperationalError, connections, router
from ginger.db.migrations import Migration
...
from ginger.db.migrations.migration import SwappableTuple
...
from ginger.db.migrations.utils import get_migration_name_timestamp
...
class Command(BaseCommand):
    ...
    def handle(self, *app_labels, **options):
        ...
        for alias in sorted(aliases_to_check):
            ...
            if connection.settings_dict["ENGINE"] != "ginger.db.backends.dummy" and any(
