...
from ginger.utils import termcolors
...
def make_style(config_string=""):
    ...
    If config_string is empty ginger.utils.termcolors.DEFAULT_PALETTE is used.
    """
...
def color_style(force_color=False):
    """
    Return a Style object from the Ginger color scheme.
    """
