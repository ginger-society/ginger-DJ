...
SECRET_KEY_INSECURE_PREFIX = "ginger-insecure-"
...
SECRET_KEY_WARNING_MSG = (
    ...
    f"automatically by Ginger. Please generate a long and random value, "
    f"otherwise many of Ginger's security-critical features will be "
    f"vulnerable to attack."
)

W001 = Warning(
    "You do not have 'ginger.middleware.security.SecurityMiddleware' "
...
W002 = Warning(
    "You do not have "
    "'ginger.middleware.clickjacking.XFrameOptionsMiddleware' in your "
...
def _security_middleware():
    return "ginger.middleware.security.SecurityMiddleware" in settings.MIDDLEWARE


def _xframe_middleware():
    return (
        "ginger.middleware.clickjacking.XFrameOptionsMiddleware" in settings.MIDDLEWARE
    )
