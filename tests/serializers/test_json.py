...
class GingerJSONEncoderTests(SimpleTestCase):
    def test_lazy_string_encoding(self):
        self.assertEqual(
            json.dumps({"lang": gettext_lazy("French")}, cls=GingerJSONEncoder),
            '{"lang": "French"}',
        )
        with override("fr"):
            self.assertEqual(
    ...
    def test_timedelta(self):
        ...
        self.assertEqual(
            json.dumps({"duration": duration}, cls=GingerJSONEncoder),
