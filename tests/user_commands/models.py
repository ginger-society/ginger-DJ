...
Ginger project. If you want to add a utility command of your own, you can.
...
``ginger.core.management.commands`` directory. This directory contains the
definitions for the base Ginger ``manage.py`` commands.
"""
