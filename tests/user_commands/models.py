...
GingerDJ project. If you want to add a utility command of your own, you can.
...
``gingerdj.core.management.commands`` directory. This directory contains the
definitions for the base GingerDJ ``manage.py`` commands.
"""
