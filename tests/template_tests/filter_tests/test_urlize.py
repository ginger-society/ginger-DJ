...
class FunctionTests(SimpleTestCase):
    ...
    def test_email(self):
        self.assertEqual(
            urlize("info@gingerproject.org"),
            '<a href="mailto:info@gingerproject.org">info@gingerproject.org</a>',
        )
    ...
    def test_parenthesis(self):
        ...
        """
        self.assertEqual(
            urlize("https://en.wikipedia.org/wiki/Ginger_(web_framework)"),
            '<a href="https://en.wikipedia.org/wiki/Ginger_(web_framework)" '
            'rel="nofollow">https://en.wikipedia.org/wiki/Ginger_(web_framework)</a>',
        )
        self.assertEqual(
            urlize("(see https://en.wikipedia.org/wiki/Ginger_(web_framework))"),
            '(see <a href="https://en.wikipedia.org/wiki/Ginger_(web_framework)" '
            'rel="nofollow">https://en.wikipedia.org/wiki/Ginger_(web_framework)</a>)',
        )
