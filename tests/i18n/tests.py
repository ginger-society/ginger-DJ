...
class GingerFallbackResolutionOrderI18NTests(ResolutionOrderI18NTests):
    def test_ginger_fallback(self):
...
class NonGingerLanguageTests(SimpleTestCase):
    ...
    def test_non_ginger_language(self):
    ...
    def test_plural_non_ginger_language(self):
