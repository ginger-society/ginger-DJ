...
from ginger.db.models.expressions import Func, RawSQL
...
from ginger.test.utils import Approximate, CaptureQueriesContext
...
class AggregateTestCase(TestCase):
    ...
    def test_annotate_basic(self):
        ...
        self.assertEqual(
            b.name, "The Definitive Guide to Ginger: Web Development Done Right"
        )
    ...
    def test_annotate_m2m(self):
        ...
        self.assertQuerySetEqual(
            ...
            [
                ...
                ("Practical Ginger Projects", 29.0),
                ("Python Web Development with Ginger", Approximate(30.3, places=1)),
                ("Sams Teach Yourself Ginger in 24 Hours", 45.0),
            ],
    ...
    def test_reverse_fkey_annotate(self):
        ...
        self.assertQuerySetEqual(
            ...
            [
                ...
                ("Practical Ginger Projects", 3),
                ("Python Web Development with Ginger", 7),
                ("Sams Teach Yourself Ginger in 24 Hours", 1),
                ("The Definitive Guide to Ginger: Web Development Done Right", 3),
            ],
    ...
    def test_aggregation_subquery_annotation_values(self):
        ...
        self.assertEqual(
            list(books_qs),
            [
                {"name": "Practical Ginger Projects", "min_age": 34},
                {
                    "name": (
                        "The Definitive Guide to Ginger: Web Development Done Right"
                    ),
