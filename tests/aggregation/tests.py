...
from gingerdj.db.models.expressions import Func, RawSQL
...
from gingerdj.test.utils import Approximate, CaptureQueriesContext
...
class AggregateTestCase(TestCase):
    ...
    def test_annotate_basic(self):
        ...
        self.assertEqual(
            b.name, "The Definitive Guide to GingerDJ: Web Development Done Right"
        )
    ...
    def test_annotate_m2m(self):
        ...
        self.assertQuerySetEqual(
            ...
            [
                ...
                ("Practical GingerDJ Projects", 29.0),
                ("Python Web Development with GingerDJ", Approximate(30.3, places=1)),
                ("Sams Teach Yourself GingerDJ in 24 Hours", 45.0),
            ],
    ...
    def test_reverse_fkey_annotate(self):
        ...
        self.assertQuerySetEqual(
            ...
            [
                ...
                ("Practical GingerDJ Projects", 3),
                ("Python Web Development with GingerDJ", 7),
                ("Sams Teach Yourself GingerDJ in 24 Hours", 1),
                ("The Definitive Guide to GingerDJ: Web Development Done Right", 3),
            ],
    ...
    def test_aggregation_subquery_annotation_values(self):
        ...
        self.assertEqual(
            list(books_qs),
            [
                {"name": "Practical GingerDJ Projects", "min_age": 34},
                {
                    "name": (
                        "The Definitive Guide to GingerDJ: Web Development Done Right"
                    ),
