...
class FieldDeconstructionTests(SimpleTestCase):
    ...
    def test_auto_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.AutoField")
        self.assertEqual(args, [])
    ...
    def test_big_integer_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.BigIntegerField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_boolean_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.BooleanField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_char_field(self):
        field = models.CharField(max_length=65)
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.CharField")
        self.assertEqual(args, [])
    ...
    def test_choices_iterator(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.IntegerField")
        self.assertEqual(args, [])
    ...
    def test_csi_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.CommaSeparatedIntegerField")
        self.assertEqual(args, [])
    ...
    def test_date_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.DateField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_datetime_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.DateTimeField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_decimal_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.DecimalField")
        self.assertEqual(args, [])
    ...
    def test_email_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.EmailField")
        self.assertEqual(args, [])
    ...
    def test_file_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.FileField")
        self.assertEqual(args, [])
    ...
    def test_file_path_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.FilePathField")
        self.assertEqual(args, [])
    ...
    def test_float_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.FloatField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_image_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.ImageField")
        self.assertEqual(args, [])
        self.assertEqual(
            kwargs,
            {
    ...
    def test_ip_address_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.IPAddressField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_generic_ip_address_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.GenericIPAddressField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_many_to_many_field_related_name(self):
        ...
        self.assertEqual(path, "gingerdj.db.models.ManyToManyField")
        self.assertEqual(args, [])
    ...
    def test_positive_integer_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.PositiveIntegerField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_positive_small_integer_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.PositiveSmallIntegerField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_positive_big_integer_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.PositiveBigIntegerField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_slug_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.SlugField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_small_integer_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.SmallIntegerField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_text_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.TextField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_time_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.TimeField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_url_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.URLField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_binary_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "gingerdj.db.models.BinaryField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
