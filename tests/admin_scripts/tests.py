...
GINGER_SETTINGS_MODULE and default settings.py files.
"""
...
class AdminScriptTestCase(SimpleTestCase):
    ...
    def run_test(self, args, settings_file=None, apps=None, umask=-1):
        ...
        if settings_file:
            test_environ["GINGER_SETTINGS_MODULE"] = settings_file
        elif "GINGER_SETTINGS_MODULE" in test_environ:
            del test_environ["GINGER_SETTINGS_MODULE"]
        python_path = [base_dir, ginger_dir, tests_dir]
...
class GingerAdminNoSettings(AdminScriptTestCase):
    ...
    def test_builtin_with_bad_environment(self):
        ...
        """
        args = ["check", "admin_scripts"]
        out, err = self.run_ginger_admin(args, "bad_settings")
        self.assertNoOutput(out)
        self.assertOutput(err, "No module named '?bad_settings'?", regex=True)
    ...
    def test_commands_with_invalid_settings(self):
        ...
        """
        args = ["startproject"]
        out, err = self.run_ginger_admin(args, settings_file="bad_settings")
        self.assertNoOutput(out)
...
class GingerAdminAlternateSettings(AdminScriptTestCase):
    ...
    def test_builtin_with_environment(self):
        ...
        """
        args = ["check", "admin_scripts"]
        out, err = self.run_ginger_admin(args, "test_project.alternate_settings")
        self.assertNoOutput(err)
        self.assertOutput(out, SYSTEM_CHECK_MSG)
...
class StartProject(LiveServerTestCase, AdminScriptTestCase):
    ...
    def test_wrong_args(self):
        ...
        """
        out, err = self.run_ginger_admin(["startproject"])
        self.assertNoOutput(out)
    ...
    def test_custom_project_template_from_tarball_by_url_ginger_user_agent(self):
        user_agent = None
    ...
    def test_honor_umask(self):
        _, err = self.run_ginger_admin(["startproject", "testproject"], umask=0o077)
        self.assertNoOutput(err)
        testproject_dir = os.path.join(self.test_dir, "testproject")
...
class StartApp(AdminScriptTestCase):
    ...
    def test_invalid_target_name(self):
        for bad_target in (
            ...
            with self.subTest(bad_target):
                _, err = self.run_ginger_admin(["startapp", "app", bad_target])
                self.assertOutput(
                    err,
    ...
    def test_importable_target_name(self):
        _, err = self.run_ginger_admin(["startapp", "app", "os"])
        self.assertOutput(
            err,
    ...
    def test_overlaying_app(self):
        ...
        self.run_ginger_admin(["startapp", "app1", "apps/app1"])
        out, err = self.run_ginger_admin(["startapp", "app2", "apps/app1"])
        self.assertOutput(
            err,
    ...
    def test_template(self):
        out, err = self.run_ginger_admin(["startapp", "new_app"])
        self.assertNoOutput(err)
...
class DiffSettings(AdminScriptTestCase):
    ...
    def test_unified(self):
        ...
        self.assertOutput(out, "+ SECRET_KEY = 'ginger_tests_secret_key'")
...
class GingerAdminSuggestions(AdminScriptTestCase):
    def setUp(self):
        super().setUp()
        self.write_settings("settings.py")
