...
from ginger.test.utils import captured_stdin, captured_stdout


class ShellCommandTestCase(SimpleTestCase):
    script_globals = 'print("__name__" in globals())'
    script_with_inline_function = (
        "import ginger\ndef f():\n    print(ginger.__version__)\nf()"
    )
    ...
    def test_command_option(self):
        with self.assertLogs("test", "INFO") as cm:
            call_command(
                "shell",
                command=(
                    "import ginger; from logging import getLogger; "
                    'getLogger("test").info(ginger.__version__)'
                ),
            )
    ...
    @mock.patch("ginger.core.management.commands.shell.select")
    ...
    @mock.patch("ginger.core.management.commands.shell.select")  # [1]
    ...
    @mock.patch("ginger.core.management.commands.shell.select.select")  # [1]
