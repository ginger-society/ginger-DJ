...
class FileStorageTests(SimpleTestCase):
    ...
    def _test_file_time_getter_tz_handling_on(self, getter):
        ...
        with timezone.override(timezone.get_fixed_timezone(-300)):
            ...
            ginger_offset = timezone.get_current_timezone().utcoffset(naive_now)
            utc_offset = datetime_timezone.utc.utcoffset(naive_now)
            self.assertGreater(algiers_offset, utc_offset)
            self.assertLess(ginger_offset, utc_offset)
...
class FileFieldStorageTests(TestCase):
    ...
    def test_files(self):
        ...
        obj1.normal.save("ginger_test.txt", ContentFile("content"))
        self.assertEqual(obj1.normal.name, "tests/ginger_test.txt")
        ...
        obj1.save()
        dirs, files = temp_storage.listdir("tests")
        self.assertEqual(sorted(files), ["assignment.txt", "ginger_test.txt"])

        # Save another file with the same name.
        obj2 = Storage()
        obj2.normal.save("ginger_test.txt", ContentFile("more content"))
        obj2_name = obj2.normal.name
        self.assertRegex(obj2_name, "tests/ginger_test_%s.txt" % FILE_SUFFIX_REGEX)
        ...
        self.assertRegex(
            obj2.normal.name, "tests/ginger_test_%s.txt" % FILE_SUFFIX_REGEX
        )
        obj2.normal.close()
    ...
    def test_empty_upload_to(self):
        ...
        obj = Storage()
        obj.empty.save("ginger_test.txt", ContentFile("more content"))
        self.assertEqual(obj.empty.name, "ginger_test.txt")
    ...
    def test_filefield_pickling(self):
        ...
        obj = Storage()
        obj.normal.save("ginger_test.txt", ContentFile("more content"))
        obj.normal.close()
        cache.set("obj", obj)
        self.assertEqual(cache.get("obj").normal.name, "tests/ginger_test.txt")
