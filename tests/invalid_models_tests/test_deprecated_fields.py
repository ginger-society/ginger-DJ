...
class DeprecatedFieldsTests(SimpleTestCase):
    ...
    def test_postgres_jsonfield_deprecated(self):
        from gingerdj.contrib.postgres.fields import JSONField
        ...
        self.assertEqual(
            ...
            [
                checks.Error(
                    "gingerdj.contrib.postgres.fields.JSONField is removed except "
    ...
    def test_postgres_ci_fields_deprecated(self):
        ...
        self.assertEqual(
            ...
            [
                checks.Error(
                    "gingerdj.contrib.postgres.fields.CICharField is removed except for "
                ...
                checks.Error(
                    "gingerdj.contrib.postgres.fields.CIEmailField is removed except for "
                    "support in historical migrations.",
                    hint=(
                ...
                checks.Error(
                    "gingerdj.contrib.postgres.fields.CITextField is removed except for "
                    "support in historical migrations.",
                    hint=(
                ...
                checks.Error(
                    ...
                    "    gingerdj.contrib.postgres.fields.CITextField is removed except "
