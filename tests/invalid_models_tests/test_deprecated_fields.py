...
class DeprecatedFieldsTests(SimpleTestCase):
    ...
    def test_postgres_jsonfield_deprecated(self):
        from ginger.contrib.postgres.fields import JSONField
        ...
        self.assertEqual(
            ...
            [
                checks.Error(
                    "ginger.contrib.postgres.fields.JSONField is removed except "
    ...
    def test_postgres_ci_fields_deprecated(self):
        ...
        self.assertEqual(
            ...
            [
                checks.Error(
                    "ginger.contrib.postgres.fields.CICharField is removed except for "
                ...
                checks.Error(
                    "ginger.contrib.postgres.fields.CIEmailField is removed except for "
                    "support in historical migrations.",
                    hint=(
                ...
                checks.Error(
                    "ginger.contrib.postgres.fields.CITextField is removed except for "
                    "support in historical migrations.",
                    hint=(
                ...
                checks.Error(
                    ...
                    "    ginger.contrib.postgres.fields.CITextField is removed except "
