...
class SchemaTests(TransactionTestCase):
    ...
    def test_creation_with_db_table_double_quotes(self):
        ...
        class Student(Model):
            ...
            class Meta:
                app_label = "schema"
                apps = new_apps
                db_table = '"%s"."GINGER_STUDENT_TABLE"' % oracle_user
        ...
        class Document(Model):
            ...
            class Meta:
                app_label = "schema"
                apps = new_apps
                db_table = '"%s"."GINGER_DOCUMENT_TABLE"' % oracle_user
    ...
    def test_namespaced_db_table_foreign_key_reference(self):
        with connection.cursor() as cursor:
            cursor.execute("CREATE SCHEMA ginger_schema_tests")

        def delete_schema():
            with connection.cursor() as cursor:
                cursor.execute("DROP SCHEMA ginger_schema_tests CASCADE")
        ...
        class Book(Model):
            class Meta:
                app_label = "schema"
                db_table = '"ginger_schema_tests"."schema_book"'
