...
class DateQuotingTest(TestCase):
    def test_ginger_date_trunc(self):
        """
        Test the custom ``ginger_date_trunc method``, in particular against
    ...
    def test_ginger_date_extract(self):
        """
        Test the custom ``ginger_date_extract method``, in particular against fields
