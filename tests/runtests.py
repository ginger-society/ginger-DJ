...
warnings.simplefilter("error", RemovedInGinger60Warning)
...
def teardown_run_tests(state):
    ...
    del os.environ["RUNNING_GINGERS_TEST_SUITE"]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "this isn't provided, either the GINGER_SETTINGS_MODULE "
    ...
    if options.settings:
        ...
        os.environ.setdefault("GINGER_SETTINGS_MODULE", "test_sqlite")
        options.settings = os.environ["GINGER_SETTINGS_MODULE"]
