...
from ginger.utils.lorem_ipsum import paragraph, paragraphs, sentence, words
...
class LoremIpsumTests(unittest.TestCase):
    ...
    @mock.patch("ginger.utils.lorem_ipsum.random.sample")
    ...
    @mock.patch("ginger.utils.lorem_ipsum.random.sample")
    @mock.patch("ginger.utils.lorem_ipsum.random.choice")
    @mock.patch("ginger.utils.lorem_ipsum.random.randint")
