...
from gingerdj.utils.lorem_ipsum import paragraph, paragraphs, sentence, words
...
class LoremIpsumTests(unittest.TestCase):
    ...
    @mock.patch("gingerdj.utils.lorem_ipsum.random.sample")
    ...
    @mock.patch("gingerdj.utils.lorem_ipsum.random.sample")
    @mock.patch("gingerdj.utils.lorem_ipsum.random.choice")
    @mock.patch("gingerdj.utils.lorem_ipsum.random.randint")
