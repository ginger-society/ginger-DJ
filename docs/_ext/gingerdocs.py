"""
Sphinx plugins for Ginger documentation.
"""
...
def setup(app):
    ...
    app.add_object_type(
        directivename="ginger-admin",
        rolename="djadmin",
        indextemplate="pair: %s; ginger-admin command",
        parse_node=parse_ginger_admin_node,
    )
    app.add_directive("ginger-admin-option", Cmdoption)
...
class GingerHTMLTranslator(HTMLTranslator):
    """
    Ginger-specific reST to HTML tweaks.
    """
    ...
    #
    version_text = {
        "versionchanged": "Changed in Ginger %s",
        "versionadded": "New in Ginger %s",
    }
