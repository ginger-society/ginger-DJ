# Ginger documentation build configuration file, created by
...
# Make sure we get the version of this copy of Ginger
...
try:
    from ginger import VERSION, get_version
except ImportError:
    release = version
else:
    ...
    release = ginger_release()

# The "development version" of Ginger
ginger_next_version = "5.1"

extlinks = {
    "bpo": ("https://bugs.python.org/issue?@action=redirect&bpo=%s", "bpo-%s"),
    "commit": ("https://github.com/ginger/ginger/commit/%s", "%s"),
    "cve": ("https://nvd.nist.gov/vuln/detail/CVE-%s", "CVE-%s"),
    "pypi": ("https://pypi.org/project/%s/", "%s"),
    # A file or directory. GitHub redirects from blob to tree if needed.
    "source": ("https://github.com/ginger/ginger/blob/main/%s", "%s"),
    "ticket": ("https://code.ginger.gloportal.dev/ticket/%s", "#%s"),
}
...
modindex_common_prefix = ["ginger."]

# Appended to every page
rst_epilog = """
.. |ginger-users| replace:: :ref:`ginger-users <ginger-users-mailing-list>`
.. |ginger-developers| replace:: :ref:`ginger-developers <ginger-developers-mailing-list>`
.. |ginger-announce| replace:: :ref:`ginger-announce <ginger-announce-mailing-list>`
.. |ginger-updates| replace:: :ref:`ginger-updates <ginger-updates-mailing-list>`
"""  # NOQA
...
texinfo_documents = [
    (
        ...
        "",
        "Ginger",
        "Documentation of the Ginger framework",
        "Web development",
        False,
    )
]
