# GingerDJ documentation build configuration file, created by
...
# Make sure we get the version of this copy of GingerDJ
...
try:
    from gingerdj import VERSION, get_version
except ImportError:
    release = version
else:
...
# The "development version" of GingerDJ
ginger_next_version = "5.1"

extlinks = {
    "bpo": ("https://bugs.python.org/issue?@action=redirect&bpo=%s", "bpo-%s"),
    "commit": ("https://github.com/gingerdj/gingerdj/commit/%s", "%s"),
    "cve": ("https://nvd.nist.gov/vuln/detail/CVE-%s", "CVE-%s"),
    "pypi": ("https://pypi.org/project/%s/", "%s"),
    # A file or directory. GitHub redirects from blob to tree if needed.
    "source": ("https://github.com/gingerdj/gingerdj/blob/main/%s", "%s"),
    "ticket": ("https://code.gingerdj.gloportal.dev/ticket/%s", "#%s"),
}
...
man_pages = [
    (
        "ref/gingerdj-admin",
        "gingerdj-admin",
        "Utility script for the GingerDJ web framework",
        ["GingerDJ Society"],
        1,
    )
]
...
texinfo_documents = [
    (
        ...
        "",
        "GingerDJ",
        "Documentation of the GingerDJ framework",
        "Web development",
        False,
    )
]
...
epub_title = project
epub_author = "GingerDJ Society"
epub_publisher = "GingerDJ Society"
epub_copyright = copyright

# The basename for the epub file. It defaults to the project name.
# epub_basename = 'GingerDJ'
